...
(function () {
    ...
    function fb(h, n) {
        ...
        for (0 > q && (q += F); q < F; q++) if (q in this && this[q] === h) return q;
        return -1;
    }
    function q(h) {
    ...
    function Ya(h, n, F) {
        ...
        if (isNaN(w)) {
            try {
                ...
                ta.style.display = "";
                U(ta, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: n + "px", fontWeight: F });
    ...
    function ib(h) {
        if (h._menuButton) h.exportEnabled ? (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ma(h._menuButton), (h._menuButton.title = h._cultureInfo.menuText)) : wa(h._menuButton);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var F = h._dropdownMenu.childNodes, q = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ba = 0; ba < F.length; ba++)
                U(F[ba], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (F[ba].innerHTML = q[ba]);
        } else
            !h._dropdownMenu &&
                h.exportEnabled &&
                w &&
    ...
    function Na(h, n, F) {
        if (w && ab) {
            ...
            Oa = q.webkitBackingStorePixelRatio || q.mozBackingStorePixelRatio || q.msBackingStorePixelRatio || q.oBackingStorePixelRatio || q.backingStorePixelRatio || 1;
            la = Sa / Oa;
            h.width = n * la;
            h.height = F * la;
            Sa !== Oa && ((h.style.width = n + "px"), (h.style.height = F + "px"), q.scale(la, la));
    ...
    function jb(h) {
        if (!kb) {
            var n = !1,
                q = !1;
            "undefined" === typeof ra.Chart.creditHref ? ((h.creditHref = ka("iuuqr;..b`ow`rkr/bnl.")), (h.creditText = ka("B`ow`rKR/bnl"))) : ((n = h.updateOption("creditText")), (q = h.updateOption("creditHref")));
            if (h.creditHref && h.creditText) {
                ...
                if (0 === h.renderCount || n || q) h._creditLink.setAttribute("href", h.creditHref), (h._creditLink.innerHTML = h.creditText);
    ...
    function va(h, n) {
        ...
        Na(q, h, n);
        w || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(q);
        return q;
    }
    function U(h, n) {
    ...
    function xa(h, n, q) {
        n.getAttribute("state") ||
            ((n.style.backgroundColor = h.toolbar.itemBackgroundColor), (n.style.color = h.toolbar.fontColor), (n.style.border = "none"), U(n, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        n.getAttribute("state") !== q &&
            (n.setAttribute("state", q),
            n.setAttribute("type", "button"),
            U(n, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
            n.setAttribute("title", h._cultureInfo[q + "Text"]),
            (n.innerHTML = "<img src='" + lb[q].image + "' alt='" + h._cultureInfo[q + "Text"] + "' />"),
    ...
    function Ta(h, n, q, w, ba) {
        if (null === h || "undefined" === typeof h) return "undefined" === typeof q ? n : q;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? n / 100 : 1);
        "undefined" !== typeof w && ((h = Math.min(w, h)), "undefined" !== typeof ba && (h = Math.max(ba, h)));
    ...
    function V(h, n, F, w, ba) {
        ...
        this.theme && q(this.parent) && q(n) && q(w)
            ? (h = q(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
            : this.parent &&
    ...
    function za(h, n) {
        ...
        if (q(this.options.margin) && h.options.subtitles)
            for (var F = h.options.subtitles, w = 0; w < F.length; w++)
                if (
                    ((q(F[w].horizontalAlign) && "center" === this.horizontalAlign) || F[w].horizontalAlign === this.horizontalAlign) &&
                    ((q(F[w].verticalAlign) && "top" === this.verticalAlign) || F[w].verticalAlign === this.verticalAlign) &&
    ...
    var ha = 20,
        ...
        Wa = {
            ...
            title: { fontFamily: Ga, fontSize: 32, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 },
            subtitles: [{ fontFamily: Ga, fontSize: C, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: v, indexLabelFontSize: C, indexLabelFontColor: fa, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [
                {
                    titleFontFamily: v,
                    titleFontSize: ha,
                    ...
                    gridThickness: 0,
                    gridColor: P,
                    stripLines: [{ labelFontFamily: v, labelFontSize: C, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
                    crosshair: { labelFontFamily: v, labelFontSize: C, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ga, color: X, thickness: 1, lineDashType: "dash" },
    ...
    var ha = 20,
        ...
        bb = {
            ...
            subtitles: [{ fontFamily: v, fontSize: C, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: v, indexLabelFontSize: C, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [
                {
                    titleFontFamily: v,
                    titleFontSize: ha,
                    ...
                    gridThickness: 1,
                    gridColor: "#BBBBBB",
                    stripLines: [{ labelFontFamily: v, labelFontSize: C, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }],
                    crosshair: { labelFontFamily: v, labelFontSize: C, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" },
                    scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" },
                },
            ],
            axisX2: [
    ...
    Ga = {
        ...
        data: [{ indexLabelFontFamily: v, indexLabelFontSize: C, indexLabelFontColor: W, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
            {
                titleFontFamily: v,
                titleFontSize: ha,
                ...
                gridColor: P,
                stripLines: [{ labelFontFamily: v, labelFontSize: C, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
                crosshair: { labelFontFamily: v, labelFontSize: C, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ga, color: X, thickness: 1, lineDashType: "dash" },
    ...
    var ha = 20,
        ...
        cb = {
            ...
            dark2: {
                ...
                subtitles: [{ fontFamily: v, fontSize: C, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
                data: [{ indexLabelFontFamily: v, indexLabelFontSize: C, indexLabelFontColor: W, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
                axisX: [
                    {
                ...
                return (R = I.replace(h, function (l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return T ? "UTC" : (String(C).match(v) || [""]).pop().replace(A, "");
                        case "z":
            ...
            for (var N = 0; C && N < C.length; N++)
                if (((n = C[N]), "." === n && 0 > I)) I = N;
                    ...
                    if ("%" === n) A *= 100;
                        ...
                        I = N + n.length - 1;
                        continue;
                    } else ("E" !== n[0] && "e" !== n[0]) || "0" !== n[n.length - 1] || (T = !0);
                    0 > I ? (R.push(n), "#" === n || "0" === n ? O++ : "," === n && K++) : (P.push(n), ("#" !== n && "0" !== n) || J++);
                }
            T && ((n = Math.floor(h)), (C = -Math.floor(Math.log(h) / Math.LN10 + 1)), (U = 0 === h ? 0 : 0 === n ? -(O + C) : String(n).length - O), (A /= Math.pow(10, U)));
            0 > I && (I = N);
            A = (h * A).toFixed(J);
            n = A.split(".");
            A = (n[0] + "").split("");
            ...
            for (T = C = N = J = I = 0; 0 < R.length; )
                if (((n = R.pop()), "#" === n || "0" === n))
                    if ((I++, I === O)) {
                        var Z = A,
                            A = [];
                        if ("0" === n) for (n = O - J - (Z ? Z.length : 0); 0 < n; ) Z.unshift("0"), n--;
                        for (; 0 < Z.length; ) (q = Z.pop() + q), T++, 0 === T % C && N === K && 0 < Z.length && (q = v + q);
                    } else 0 < A.length ? ((q = A.pop() + q), J++, T++) : "0" === n && ((q = "0" + q), J++, T++), 0 === T % C && N === K && 0 < A.length && (q = v + q);
                else
                    ("E" !== n[0] && "e" !== n[0]) || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n)
                        ? "," === n
                            ? (N++, (C = T), (T = 0), 0 < A.length && (q = v + q))
                            : (q = 1 < n.length && (('"' === n[0] && '"' === n[n.length - 1]) || ("'" === n[0] && "'" === n[n.length - 1])) ? n.slice(1, n.length - 1) + q : n + q)
        ...
        Pa = function (h) {
            var n = 0,
                q = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? ((n = h.offsetX), (q = h.offsetY)) : h.layerX || 0 == h.layerX ? ((n = h.layerX), (q = h.layerY)) : ((n = h.pageX - h.target.offsetLeft), (q = h.pageY - h.target.offsetTop));
            return { x: n, y: q };
        },
        ab = !0,
        ...
        ca = function (h, n, q, w, v, C, A, I, O, R, T, P, J) {
            ...
            h.globalAlpha = 1;
            0 < A && ((J = 0 === A % 2 ? 0 : 0.5), h.beginPath(), (h.lineWidth = A), (h.strokeStyle = I), h.moveTo(n, q), h.rect(n - J, q - J, w - n + 2 * J, v - q + 2 * J), h.stroke());
            h.restore();
            !0 === O &&
                (h.save(),
                h.beginPath(),
        ...
        ka = function (h) {
            for (var n = "", q = 0; q < h.length; q++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(q));
            return n;
        },
        db =
            window &&
            ...
            (-1 !== window[ka("mnb`uhno")].href.indexOf(ka("b`ow`rkr/bnl")) || -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gdonqhy/bnl")) || -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gheemd"))),
        ...
        T._fTWm = function (h) {
            if ("undefined" === typeof T.pro.sCH && !db)
                try {
                    ...
                    v[T.fSDec("gnou")] = 11 + T.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");
                    v[T.fSDec("ghmmRuxmd")] = T.fSDec("fsdx");
                    q = "cm" === T.pos[n] || "um" === T.pos[n] ? 0 : h.width - v[T.fSDec("ld`rtsdUdyu")](T.fSDec("B`ow`rKR!Ush`m")).width;
                    w = "um" === T.pos[n] ? 0 : h.height - 11;
                    v[T.fSDec("ghmmUdyu")](T.fSDec("B`ow`rKR!Ush`m"), q, w);
                    "cs" === T.pos[n] && (h[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"));
                } catch (C) {}
        };
    })();
    V.prototype.setOptions = function (h, n) {
        if (ra[this._defaultsKey]) {
            var q = ra[this._defaultsKey],
                w;
            for (w in q) "publicProperties" !== w && q.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : q[w]);
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if ((this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray)) {
                ...
                (this.options = "undefined" === typeof h ? {} : h),
                    ...
                    this.optionsName ? (n = this.optionsName) : (n = this._defaultsKey) && 0 !== n.length ? ((q = n.charAt(0).toLowerCase()), 1 < n.length && (q = q.concat(n.slice(1))), (n = q)) : (n = void 0),
                    (h[n] = this.options);
    };
    ...
    V.prototype.updateOption = function (h) {
        ...
        this.theme && q(this.parent) && q(C) && q(I)
            ? (w = q(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
            : this.parent &&
              this.parent.themeOptions &&
              this.parent.themeOptions[C] &&
              (null === I ? (w = this.parent.themeOptions[C]) : 0 < this.parent.themeOptions[C].length && ((w = Math.min(this.parent.themeOptions[C].length - 1, I)), (w = this.parent.themeOptions[C][w])));
        this.themeOptions = w;
    ...
    V.prototype.addEventListener = function (h, n, q) {
        h && n && ((this._eventListeners[h] = this._eventListeners[h] || []), this._eventListeners[h].push({ context: q || this, eventHandler: n }));
    };
    ...
    V.prototype.dispatchEvent = function (h, n, q) {
        if (h && this._eventListeners[h]) {
            n = n || {};
            for (var w = this._eventListeners[h], v = 0; v < w.length; v++) w[v].eventHandler.call(w[v].context, n);
        }
    ...
    ja.prototype._initialize = function () {
        q(this.padding) || "object" !== typeof this.padding
            ...
            : ((this.topPadding = q(this.padding.top) ? 0 : Number(this.padding.top) | 0),
              (this.rightPadding = q(this.padding.right) ? 0 : Number(this.padding.right) | 0),
              (this.bottomPadding = q(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0),
              (this.leftPadding = q(this.padding.left) ? 0 : Number(this.padding.left) | 0));
    };
    ja.prototype.render = function (h) {
        if (0 !== this.fontSize) {
            ...
            ((0 < this.borderThickness && this.borderColor) || this.backgroundColor) && this.ctx.roundRect(0, q, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor);
            this.ctx.fillStyle = this.fontColor;
            for (q = 0; q < this._wrappedText.lines.length; q++) {
                C = this._wrappedText.lines[q];
                if ("right" === this.horizontalAlign || "right" === this.textAlign) w = this.width - C.width - this.rightPadding;
                else if ("left" === this.horizontalAlign || "left" === this.textAlign) w = this.leftPadding;
                else if ("center" === this.horizontalAlign || "center" === this.textAlign) w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - C.width / 2 + this.leftPadding;
    ...
    ja.prototype._getLineWithWidth = function (h, n, q) {
        ...
        q > n && 1 < A.length && ((A = A.substr(0, A.length - 1)), (q = this.ctx.measureText(A).width));
        n = !0;
        if (A.length === h.length || " " === h[A.length]) n = !1;
        n && ((h = A.split(" ")), 1 < h.length && h.pop(), (A = h.join(" ")), (q = this.ctx.measureText(A).width));
    ...
    za.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)), (I = 0.5 * n.height - this.margin - 2), (C = 0))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign || "right" === this.horizontalAlign
                      ? (null === this.maxWidth && (this.maxWidth = n.height - 4), (I = 0.5 * n.width - this.margin - 2))
                      : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = n.width - 4), (I = 0.5 * n.height - 4)));
            var R;
            q(this.padding) || "number" !== typeof this.padding
                ? q(this.padding) ||
                  "object" !== typeof this.padding ||
                  ((R = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0), (R += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0))
                : (R = 2 * this.padding);
            ...
            R = I.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((v = n.y1 + 2), (J = "top")) : "bottom" === this.verticalAlign && ((v = n.y2 - 2 - R.height), (J = "bottom")),
                  "left" === this.horizontalAlign ? (w = n.x1 + 2) : "center" === this.horizontalAlign ? (w = n.x1 + n.width / 2 - R.width / 2) : "right" === this.horizontalAlign && (w = n.x2 - 2 - R.width - A),
                  (K = this.horizontalAlign),
                  (this.width = R.width),
                  (this.height = R.height))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((w = n.x1 + 2), (v = n.y2 - 2 - (this.maxWidth / 2 - R.width / 2)), (C = -90), (J = "left"), (this.width = R.height), (this.height = R.width))
                      : "right" === this.horizontalAlign
                      ? ((w = n.x2 - 2), (v = n.y1 + 2 + (this.maxWidth / 2 - R.width / 2)), (C = 90), (J = "right"), (this.width = R.height), (this.height = R.width))
                      : "center" === this.horizontalAlign && ((v = h.y1 + (h.height / 2 - R.height / 2)), (w = h.x1 + (h.width / 2 - R.width / 2)), (J = "center"), (this.width = R.width), (this.height = R.height)),
                  (K = "center"));
            I.x = w;
            I.y = v;
            I.angle = C;
    ...
    Va.prototype.get = function (h, q) {
        var w = null;
        0 < this.pool.length ? ((w = this.pool.pop()), Na(w, h, q)) : (w = va(h, q));
        return w;
    };
    ...
    v = Qa.Chart = (function () {
        ...
        function n(a, d, c) {
            ...
            this.theme = q(d.theme) || q(this.predefinedThemes[d.theme]) ? "light1" : d.theme;
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId)
                ? ((this.container.innerHTML = ""),
                  ...
                  (this.x2 = this.width),
                  (this.y2 = this.height),
                  (this.selectedColorSet = "undefined" !== typeof Aa[this.colorSet] ? Aa[this.colorSet] : Aa.colorSet1),
                  ...
                  this.canvas.getContext &&
                      ...
                      this.overlaidCanvas.getContext &&
                          (this._canvasJSContainer.appendChild(this.overlaidCanvas), (this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d")), (this.overlaidCanvasCtx.textBaseline = "top"), Da(this.overlaidCanvasCtx)),
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    b = (Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[s].x ? 0.01 : a[l].x - a[s].x)) * (d - 1)) / 2 + 1;
                    var B = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = (a[s].x > a[f].x && 0 < B) || (a[s].x < a[f].x && 0 > B) ? { x: a[s].x + B / 3, y: a[s].y + b / 3 } : { x: a[s].x, y: a[s].y + b / 9 };
                    s = e;
                    f = 0 === s ? 0 : s - 1;
                    l = s === a.length - 1 ? s : s + 1;
        ...
        function C(a, d, c, b, e, f, l, s, B, k) {
            ...
            B && 0 < s.thickness
                ...
                : 0 < s.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - p, e - l.thickness / 2));
            a.stroke();
        ...
        function A(a, d, c, b, e, f) {
            ...
            "axisX" === e
                ? ("left" === f || "bottom" === f
                      ? ((this.optionsName = "axisX"), q(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisX[b]))
                      : ((this.optionsName = "axisX2"), q(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisX2[b])),
                  this.options.interval || (this.intervalType = null))
                : "left" === f || "bottom" === f
                ? ((this.optionsName = "axisY"), q(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisY[b]))
                : ((this.optionsName = "axisY2"), q(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisY2[b]));
            ...
            this.options.scaleBreaks && (this.scaleBreaks = new ha(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
            this.stripLines = [];
            if (this.options.stripLines && 0 < this.options.stripLines.length)
                for (a = 0; a < this.options.stripLines.length; a++) this.stripLines.push(new R(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this));
        ...
        function fa(a, d, c, b, e, f) {
            ...
            this.lineThickness = q(c.lineThickness) ? f.lineThickness : this.lineThickness;
        ...
        n.prototype._updateOptions = function () {
                      ...
                      J(
                          ...
                          function () {
                              ...
                              a.zoomEnabled || a.panEnabled
                                  ? ((a.zoomEnabled = !0), (a.panEnabled = !1), xa(a, a._zoomButton, "pan"), (a._defaultCursor = "default"), (a.overlaidCanvas.style.cursor = a._defaultCursor))
            ...
            "none" !== this._toolBar.style.display &&
                this._zoomButton &&
                (this.panEnabled ? xa(a, a._zoomButton, "zoom") : xa(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && xa(a, a._resetButton, "reset"));
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if ((a++, !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type))) {
                        ...
                        "error" === b.type &&
                            ((b.linkedDataSeriesIndex = q(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex),
        ...
        n.prototype.setLayout = function () {
            ...
            if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled))
                for (d = 0; d < this._axes.length; d++)
                    if (!q(this._axes[d].viewportMinimum) || !q(this._axes[d].viewportMaximum)) {
                        c = !0;
                        break;
                    }
            c
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    w ? ((this._breaksCanvas = va(this.width, this.height, !0)), (this._breaksCanvasCtx = this._breaksCanvas.getContext("2d"))) : ((this._breaksCanvas = this.canvas), (this._breaksCanvasCtx = this.ctx));
                    break;
                }
        ...
        n.prototype.renderElements = function () {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    this.animatedRender && ((s.targetCanvasCtx.miterLimit = e), B && c.push(B));
                }
            this.ctx.miterLimit = a;
            this.animatedRender &&
                this._breaksCanvasCtx &&
                c.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: N.fadeInAnimation, easingFunction: N.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 });
            this.animatedRender && 0 < this._indexLabels.length && ((e = va(this.width, this.height).getContext("2d")), c.push(this.renderIndexLabels(e)));
            var m = this;
            if (0 < c.length)
                (m.disableToolTip = !0),
                    m._animator.animate(
                    ...
                    if ("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement)
                        var r = a.axisX.sessionVariables.newViewportMinimum
                            ...
                            g = a.axisX.sessionVariables.newViewportMaximum
                                ...
                                : Infinity;
                    if ((s.dataPoints[B].x && s.dataPoints[B].x.getTime) || "dateTime" === s.xValueType) f = !0;
                    for (B = 0; B < s.dataPoints.length; B++) {
                        "undefined" === typeof s.dataPoints[B].x && (s.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0));
                        s.dataPoints[B].x.getTime ? ((f = !0), (b = s.dataPoints[B].x.getTime())) : (b = s.dataPoints[B].x);
                        e = s.dataPoints[B].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < B) {
                            ...
                            } else (t = b - s.dataPoints[B - 1].x), 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t);
                            null !== e &&
                                null !== s.dataPoints[B - 1].y &&
                                (a.axisY.logarithmic
                                    ? ((t = e / s.dataPoints[B - 1].y), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e - s.dataPoints[B - 1].y), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
                        }
                        if (b < r && !k) null !== e && (p = b);
                        else {
                            if (!k && ((k = !0), 0 < B)) {
                            ...
                            s.dataPoints[B].label && (a.axisX.labels[b] = s.dataPoints[B].label);
        ...
        n.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], s = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
                        var da = a.axisX.sessionVariables.newViewportMinimum
                            ...
                            u = a.axisX.sessionVariables.newViewportMaximum
                                ...
                                ? this.options.axisX.maximum
                                : Infinity;
                    if ((p.dataPoints[r].x && p.dataPoints[r].x.getTime) || "dateTime" === p.xValueType) f = !0;
                    for (r = 0; r < p.dataPoints.length; r++) {
                        "undefined" === typeof p.dataPoints[r].x && (p.dataPoints[r].x = r + (a.axisX.logarithmic ? 1 : 0));
                        p.dataPoints[r].x.getTime ? ((f = !0), (b = p.dataPoints[r].x.getTime())) : (b = p.dataPoints[r].x);
                        ...
                        if (0 < r) {
                            ...
                            } else (y = b - p.dataPoints[r - 1].x), 0 > y && (y *= -1), c.minDiff > y && 0 !== y && (c.minDiff = y);
                            null !== e &&
                                null !== p.dataPoints[r - 1].y &&
                                (a.axisY.logarithmic
                                    ? 0 < e && ((y = e / p.dataPoints[r - 1].y), 1 > y && (y = 1 / y), d.minDiff > y && 1 !== y && (d.minDiff = y))
                                    : ((y = e - p.dataPoints[r - 1].y), 0 > y && (y *= -1), d.minDiff > y && 0 !== y && (d.minDiff = y)));
                        }
                        if (b < da && !g) null !== p.dataPoints[r].y && (h = b);
                            ...
                            null === p.dataPoints[r].y
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                                  ...
                                  0 <= e ? (l[b] ? (l[b] += e) : ((l[b] = e), (B = Math.min(e, B)))) : s[b] ? (s[b] += e) : ((s[b] = e), (k = Math.max(e, k))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                        ...
                        (d.dataPointYPositiveSums
                            ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, s))
                            : ((d.dataPointYPositiveSums = l), (d.dataPointYNegativeSums = s)));
                ...
                for (r in l)
                    l.hasOwnProperty(r) &&
                        ...
                        a > d.max && (d.max = a),
                        r < c.viewPortMin || r > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (r in s)
                    s.hasOwnProperty(r) &&
                        !isNaN(r) &&
                        ((a = s[r]),
                        ...
                        r < c.viewPortMin || r > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))));
            }
        };
        n.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                a.axisY.logarithmic
                    ? ((d.max = q(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05))), (d.min = q(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
                    : l && !s
                    ? ((d.max = q(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)), (d.min = q(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
                    : l && s
                    ? ((d.max = q(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)), (d.min = q(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)))
                    : !l && s && ((d.max = q(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = q(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = B;
            }
        ...
        n.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                        var q = a.axisX.sessionVariables.newViewportMinimum
                            ...
                            u = a.axisX.sessionVariables.newViewportMaximum
                                ...
                                ? this.options.axisX.maximum
                                : Infinity;
                    if ((k.dataPoints[m].x && k.dataPoints[m].x.getTime) || "dateTime" === k.xValueType) s = !0;
                    for (m = 0; m < k.dataPoints.length; m++) {
                        "undefined" === typeof k.dataPoints[m].x && (k.dataPoints[m].x = m + (a.axisX.logarithmic ? 1 : 0));
                        k.dataPoints[m].x.getTime ? ((s = !0), (b = k.dataPoints[m].x.getTime())) : (b = k.dataPoints[m].x);
                        ...
                        0 < m &&
                            (a.axisX.logarithmic
                                ? ((t = b / k.dataPoints[m - 1].x), 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t))
                                : ((t = b - k.dataPoints[m - 1].x), 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)),
                            e &&
                                null !== e[0] &&
                                k.dataPoints[m - 1].y &&
                                null !== k.dataPoints[m - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((t = e[0] / k.dataPoints[m - 1].y[0]), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e[0] - k.dataPoints[m - 1].y[0]), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))));
                        if (!(b < q) || p) {
                            if (!p && ((p = !0), 0 < m)) {
                                m -= 2;
                                g = h;
        ...
        n.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if ((s.dataPoints[B].x && s.dataPoints[B].x.getTime) || "dateTime" === s.xValueType) f = !0;
                    for (B = 0; B < s.dataPoints.length; B++)
                        "undefined" !== typeof s.dataPoints[B].isCumulativeSum && !0 === s.dataPoints[B].isCumulativeSum
                            ? ((s.dataPointEOs[B].cumulativeSumYStartValue = 0), (s.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum), (s.dataPoints[B].y = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum))
                            : "undefined" !== typeof s.dataPoints[B].isIntermediateSum && !0 === s.dataPoints[B].isIntermediateSum
                            ? ((s.dataPointEOs[B].cumulativeSumYStartValue = p),
                              (s.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                              (s.dataPoints[B].y = 0 === B ? 0 : b),
                              (p = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                              (b = 0))
                            : ((e = "number" !== typeof s.dataPoints[B].y ? 0 : s.dataPoints[B].y),
                              (s.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                              (s.dataPointEOs[B].cumulativeSum = 0 === B ? e : s.dataPointEOs[B - 1].cumulativeSum + e),
                              (b += e));
                    for (B = 0; B < s.dataPoints.length; B++)
                        if (
                            ("undefined" === typeof s.dataPoints[B].x && (s.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)),
                            ...
                            b < c.min && (c.min = b),
                            b > c.max && (c.max = b),
                            s.dataPointEOs[B].cumulativeSum < d.min && (d.min = s.dataPointEOs[B].cumulativeSum),
                            s.dataPointEOs[B].cumulativeSum > d.max && (d.max = s.dataPointEOs[B].cumulativeSum),
                            0 < B &&
                                (a.axisX.logarithmic
                                    ? ((p = b / s.dataPoints[B - 1].x), 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p))
                                    : ((p = b - s.dataPoints[B - 1].x), 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)),
                                null !== e &&
                                    null !== s.dataPoints[B - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = s.dataPointEOs[B].cumulativeSum / s.dataPointEOs[B - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = s.dataPointEOs[B].cumulativeSum - s.dataPointEOs[B - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                            !(b < r) || k)
                        ) {
                            if (!k && ((k = !0), 0 < B)) {
                                B -= 2;
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < B &&
                                (s.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[B - 1].cumulativeSum),
                                s.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[B - 1].cumulativeSum));
                            s.dataPointEOs[B].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[B].cumulativeSum);
                            s.dataPointEOs[B].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[B].cumulativeSum);
                        }
                    s.axisX.valueType = s.xValueType = f ? "dateTime" : "number";
                }
        };
        n.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, r, s = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
                            var h = e.data[a.dataSeriesIndexes[B]];
                            if (!(4 > h.dataPoints.length))
                                for (s = 0; s < h.dataPoints.length; s++)
                                    if (
                                        (b &&
                                            ((r = ((l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                                            (g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x),
                                            (r = Math.floor((g - k) / r)),
                                            g < f[r].min && (f[r].min = g),
                                            g > f[r].max && (f[r].max = g)),
                                        c)
                                        ...
                                        if ((g = "waterfall" === a.type ? h.dataPointEOs[s].cumulativeSum : h.dataPoints[s].y) && g.length)
                                            for (var w = 0; w < g.length; w++) (r = Math.floor((g[w] - m) / n)), g[w] < d[r].min && (d[r].min = g[w]), g[w] > d[r].max && (d[r].max = g[w]);
                                        else q(g) || ((r = Math.floor((g - m) / n)), g < d[r].min && (d[r].min = g), g > d[r].max && (d[r].max = g));
                                    }
                        }
                }
            }
            ...
            for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var s = 0; s < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); s++) this._axes[l].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity });
                }
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], s = 0; s < f.plotUnits.length; s++)
                        (b = f.plotUnits[s]),
                            "line" === b.type ||
                            "stepLine" === b.type ||
                            "spline" === b.type ||
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (s in r) r.hasOwnProperty(s) && !isNaN(s) && ((p = -1 * r[s]), q(p) || ((g = Math.floor((p - B) / b)), p < m[g].min && (m[g].min = p), p > m[g].max && (m[g].max = p)));
                        ...
                        if (this._axes[l].scaleBreaks.customBreaks)
                            for (s = 0; s < this._axes[l].scaleBreaks.customBreaks.length; s++)
                                for (b = 0; b < f.length; b++)
                                    if (
                                        (this._axes[l].scaleBreaks.customBreaks[s].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].endValue) ||
                                        (this._axes[l].scaleBreaks.customBreaks[s].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].endValue) ||
                                        (f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].startValue && this._axes[l].scaleBreaks.customBreaks[s].startValue <= f[b].end) ||
                                        (f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].endValue && this._axes[l].scaleBreaks.customBreaks[s].endValue <= f[b].end)
                                    )
                                        f.splice(b, 1), b--;
                        f.sort(function (a, b) {
                            return b.diff - a.diff;
                        });
                        for (s = 0; s < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); s++)
                            (b = a(f[s].start, f[s].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                                this._axes[l].scaleBreaks.autoBreaks.push(new fa(this, "autoBreaks", b, s, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), (this.isDrag = !1);
                        ...
                        for (c = 0; c < d.length; c++)
                            if (
                                ...
                                (!q(this._lastTouchData.scroll) && !this._lastTouchData.scroll) || (!this._lastTouchData.scroll && 250 < f) || "click" === e)
                            )
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    l &&
                        ...
                        l && this.zoomEnabled && "none" === this._zoomButton.style.display && (Ma(this._zoomButton, this._resetButton), xa(this, this._zoomButton, "pan"), xa(this, this._resetButton, "reset")));
                }
            }
            this.isDrag = !1;
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var s = 0; s < this.axisX.length; s++)
                        this.axisX[s].crosshair && this.axisX[s].crosshair.enabled && (this.axisX[s].crosshair.hide(), this.axisX[s].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX[s].options }, this.axisX[s].crosshair));
                    for (s = 0; s < this.axisX2.length; s++)
                        this.axisX2[s].crosshair &&
                            this.axisX2[s].crosshair.enabled &&
                            (this.axisX2[s].crosshair.hide(), this.axisX2[s].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX2[s].options }, this.axisX2[s].crosshair));
                    for (s = 0; s < this.axisY.length; s++)
                        this.axisY[s].crosshair && this.axisY[s].crosshair.enabled && (this.axisY[s].crosshair.hide(), this.axisY[s].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY[s].options }, this.axisY[s].crosshair));
                    for (s = 0; s < this.axisY2.length; s++)
                        this.axisY2[s].crosshair &&
                            this.axisY2[s].crosshair.enabled &&
                            (this.axisY2[s].crosshair.hide(), this.axisY2[s].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY2[s].options }, this.axisY2[s].crosshair));
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        this.validateRegion(b, s, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid &&
        ...
        n.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, B = [], k = [], m = [], p = 0; p < this._axes.length; p++)
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (r > g)
                    var t = g,
                        g = r,
                        r = t;
                if (p.scaleBreaks) for (t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++) f = p.scaleBreaks._appliedBreaks[t].startValue <= r && p.scaleBreaks._appliedBreaks[t].endValue >= g;
                if (isFinite(p.dataInfo.minDiff))
                    if (
                        ((t = p.getApparentDifference(r, g, null, !0)),
                        !(
                            f ||
                            (!(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && ((p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3)) || (!p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)))) ||
                            r < p.minimum ||
                            g > p.maximum
                        ))
                    )
        ...
        n.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var da = ma("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    n = q(m.dataPoint.indexLabelLineThickness) ? (q(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness) : m.dataPoint.indexLabelLineThickness,
                ...
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) D = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: x.total, percent: x.percent };
                ...
                if (null !== E && "" !== E) {
                    ...
                    l = s = 2;
                    "horizontal" === D ? ((B = h.width), (k = h.height)) : ((k = h.width), (B = h.height));
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== x
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < v
                                  ? ((g = m.point.y + ("horizontal" === D ? t / 2 : 0) - k - s - b), g < e && ((g = "auto" === x ? Math.max(m.point.y, e) + t / 2 + s : e + t / 2 + s), (A = g + k > m.point.y)))
                                  : ((g = m.point.y + t / 2 + s + b), g > f - k && ((g = "auto" === x ? Math.min(m.point.y, f) + t / 2 - k - s : f + t / 2 - k), (A = g < m.point.y))))
                            : ((e = Math.max(m.bounds.y1, c.y1)),
                              ...
                              (b =
                                  0 <= p.indexOf("range") || "error" === p
                                      ...
                                      : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === D ? s : 0)),
                              0 < v
                                  ? ((g = Math.max(m.point.y, b)), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - s, c.y1 + s)))
                                  : ((g = Math.min(m.point.y, b)), g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + s, c.y2 - k - s))),
                              (g = Math.min(g, f)));
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((x = "auto"), (l = 4)) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"),
                            (g = m.point.y + t / 2 - k / 2 + s),
                            "inside" !== x
                                ? ((e = c.x1),
                                  (f = c.x2),
                                  0 > v
                                      ? ((r = m.point.x - ("horizontal" === D ? B : B - t / 2) - l - b), r < e && ((r = "auto" === x ? Math.max(m.point.x, e) + l : e + l), (A = r + B > m.point.x)))
                                      : ((r = m.point.x + ("horizontal" === D ? 0 : t / 2) + l + b),
                                        r > f - B - l - b && ((r = "auto" === x ? Math.min(m.point.x, f) - ("horizontal" === D ? B : B / 2) - l : f - B - l), (A = r < m.point.x))))
                                  ...
                                  (b =
                                      0 <= p.indexOf("range") || "error" === p
                                          ? 0 > v
                                              ...
                                              : Math.min(m.bounds.x2, c.x2) - B / 2 - l + ("horizontal" === D ? 0 : t / 2)
                                          : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === D ? 0 : t / 2)),
                                  (r = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === D ? B / 2 : 0) : Math.min(m.point.x, b) - B / 2),
                                  (r = Math.max(r, e)));
                    "vertical" === D && (g += k - t / 2);
                    h.x = r;
                    h.y = g;
                    ...
                    n &&
                        "inside" !== x &&
                        ((0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2) || !A) &&
                        ((0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2) || !A) &&
                        ((d.lineWidth = n),
                        ...
                        0 <= p.indexOf("bar") || ("error" === p && m.axisSwapped)
                            ? d.lineTo(r + (0 < m.direction ? -l : B + l) + ("vertical" === D ? -t / 2 : 0), g + ("vertical" === D ? -k / 2 : k / 2 - t / 2) - s)
                            : 0 <= p.indexOf("column") || ("error" === p && !m.axisSwapped)
                            ? d.lineTo(r + B / 2 - ("horizontal" === D ? 0 : t / 2), g + ("vertical" === D ? (g - k < m.point.y ? 0 : -k) + s : (g - t / 2 < m.point.y ? k : 0) - t / 2))
                            : d.lineTo(r + B / 2 - ("horizontal" === D ? 0 : t / 2), g + ("vertical" === D ? (g - k < m.point.y ? 0 : -k) : (g - t / 2 < m.point.y ? k : 0) - t / 2)),
                        d.stroke());
                }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) (m = this._indexLabels[a]), (h = ma("indexLabelBackgroundColor", m.dataPoint, m.dataSeries)), (m.dataSeries.indexLabelBackgroundColor = q(h) ? (w ? "transparent" : null) : h);
            return d;
        };
        n.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    var t = k.id;
                    this._eventManager.objectMap[t] = { objectType: "dataSeries", dataSeriesIndex: B };
                    t = O(t);
                    b.strokeStyle = t;
                    ...
                    if (0 < m.length) {
                        for (var D = !1, u = 0; u < m.length; u++)
                            if (((n = m[u].x.getTime ? m[u].x.getTime() : m[u].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !D)))))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || D || q) && (c.stroke(), w && b.stroke()), (D = !0);
                                else {
                                    n = a.axisX.convertValueToPixel(n);
                                    x = a.axisY.convertValueToPixel(m[u].y);
                                    var E = k.dataPointIds[u];
                                    this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: n, y1: x };
                                    q || D
                                        ? (!q && k.connectNullData
                                              ? (c.setLineDash &&
                                                    (k.options.nullDataLineDashType || (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                                                    (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), (p = k.nullDataLineDashType), c.setLineDash(r)),
                                                c.lineTo(n, x),
                                                w && b.lineTo(n, x))
                                              : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))),
                                          (D = q = !1))
                                        : (c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                    l = { x: n, y: x };
                                    u < m.length - 1 &&
                                        (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                        c.beginPath(),
                                        c.moveTo(n, x),
                                        (h = m[u].lineColor || t),
                                        (c.strokeStyle = h),
                                        c.setLineDash && (m[u].lineDashType ? ((p = m[u].lineDashType), c.setLineDash(I(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) {
                                        var z = k.getMarkerProperties(u, n, x, c);
                                        f.push(z);
                                        E = O(E);
                                        w && f.push({ x: n, y: x, ctx: b, type: z.type, size: z.size, color: E, borderColor: E, borderThickness: z.borderThickness });
                                    }
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: n, y: x }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: t });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
        ...
        n.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length) {
                        for (var D = !1, u = 0; u < m.length; u++)
                            if (((n = m[u].getTime ? m[u].x.getTime() : m[u].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !D)))))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || D || q) && (c.stroke(), w && b.stroke()), (D = !0);
                                else {
                                    var E = x;
                                    n = a.axisX.convertValueToPixel(n);
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: n, y1: x };
                                    q || D
                                        ? (!q && k.connectNullData
                                              ? (c.setLineDash &&
                                                    (k.options.nullDataLineDashType || (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                                              ...
                                              : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))),
                                          (D = q = !1))
                                        : (c.lineTo(n, E), w && b.lineTo(n, E), c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                    l = { x: n, y: x };
                                    u < m.length - 1 &&
                                        (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (m[u].lineDashType ? ((p = m[u].lineDashType), c.setLineDash(I(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize)
                                        (E = k.getMarkerProperties(u, n, x, c)), f.push(E), (z = O(z)), w && f.push({ x: n, y: x, ctx: b, type: E.type, size: E.size, color: z, borderColor: z, borderThickness: E.borderThickness });
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: m[u], dataSeries: k, point: { x: n, y: x }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: t });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                ...
                for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length)
                        for (n = !1, q = 0; q < m.length; q++)
                            if (((u = m[q].getTime ? m[q].x.getTime() : m[q].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))))
                                if ("number" !== typeof m[q].y)
                                    0 < q &&
                                        !n &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < x.length && (k.options.nullDataLineDashType || !m[q - 1].lineDashType) && ((x[x.length - 1].newLineDashArray = r), (p = k.nullDataLineDashType))
                                            : (d(x), (x = []))),
                                        (n = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: q, x1: u, y1: n };
                                    x[x.length] = { x: u, y: n };
                                    q < m.length - 1 &&
                                        (h !== (m[q].lineColor || t) || p !== (m[q].lineDashType || k.lineDashType)) &&
                                        ((h = m[q].lineColor || t),
                                        (x[x.length - 1].newStrokeStyle = h),
                                        b.setLineDash && (m[q].lineDashType ? ((p = m[q].lineDashType), (x[x.length - 1].newLineDashArray = I(p, k.lineThickness))) : ((p = k.lineDashType), (x[x.length - 1].newLineDashArray = g))));
                                    if (0 < m[q].markerSize || 0 < k.markerSize) {
                                        var E = k.getMarkerProperties(q, u, n, b);
                                        l.push(E);
                                        D = O(D);
                                        w && l.push({ x: u, y: n, ctx: e, type: E.type, size: E.size, color: D, borderColor: D, borderThickness: E.borderThickness });
                                    }
                                    (m[q].indexLabel || k.indexLabel || m[q].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: m[q], dataSeries: k, point: { x: u, y: n }, direction: 0 > m[q].y === a.axisY.reversed ? 1 : -1, color: t });
                                    n = !1;
                                }
                    d(x);
                }
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < t.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)
                            if ((t[f].getTime ? (B = t[f].x.getTime()) : (B = t[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y)) {
                                ...
                                ca(c, a.axisX.reversed ? q : l, s, a.axisX.reversed ? l : q, u, b, 0, null, h && (a.axisY.reversed ? 0 > t[f].y : 0 <= t[f].y), (a.axisY.reversed ? 0 <= t[f].y : 0 > t[f].y) && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: l, y1: s, x2: q, y2: u };
                                b = O(b);
                                w && ca(this._eventManager.ghostCtx, a.axisX.reversed ? q : l, s, a.axisX.reversed ? l : q, u, b, 0, null, !1, !1, !1, !1);
                                (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "column",
                                        dataPoint: t[f],
                                        dataSeries: g,
                                        point: { x: l + (q - l) / 2, y: 0 > t[f].y === a.axisY.reversed ? s : u },
                                        direction: 0 > t[f].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: l, y1: Math.min(s, u), x2: q, y2: Math.max(s, u) },
                                        color: b,
                                    });
                            }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var x = (m - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    D = (x + g) << 0,
                                    E;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    (s[b] = u[k].y + (s[b] ? s[b] : 0)), 0 < s[b] && ((p = a.axisY.convertValueToPixel(s[b])), (E = "undefined" !== typeof f[b] ? f[b] : r), (f[b] = p));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
                                    (B[b] = u[k].y + (B[b] ? B[b] : 0)), (E = a.axisY.convertValueToPixel(B[b])), (p = "undefined" !== typeof l[b] ? l[b] : r), (l[b] = E);
                                else if (((p = a.axisY.convertValueToPixel(u[k].y)), 0 <= u[k].y)) {
                                    var z = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= z;
                                    E = r - z;
                                    f[b] = z + (E - p);
                                } else (z = l[b] ? l[b] : 0), (E = p + z), (p = r + z), (l[b] = z + (E - p));
                                b = u[k].color ? u[k].color : q._colorSet[k % q._colorSet.length];
                                ca(c, x, a.axisY.reversed ? E : p, D, a.axisY.reversed ? p : E, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, q.fillOpacity);
                                b = q.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: p, x2: D, y2: E };
                                b = O(b);
                                w && ca(this._eventManager.ghostCtx, x, p, D, E, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || q.indexLabel || u[k].indexLabelFormatter || q.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: x, y1: Math.min(p, E), x2: D, y2: Math.max(p, E) },
                                        color: b,
                                    });
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t],
                        ...
                        u = q.dataPoints;
                    if (0 < u.length)
                        for (var n = 5 < g && q.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                m = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                                    ...
                                    (B[b] = p + ("undefined" !== typeof B[b] ? B[b] : 0)), (E = a.axisY.convertValueToPixel(B[b])), (p = l[b] ? l[b] : r), (l[b] = E);
                                    ...
                                    f[b] = z + (E - p);
                                } else (z = "undefined" !== typeof l[b] ? l[b] : 0), (E = p + z), (p = r + z), a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.y2 - E) && (E = e.y2), (l[b] = z + (E - p));
                                b = u[k].color ? u[k].color : q._colorSet[k % q._colorSet.length];
                                ca(c, x, a.axisY.reversed ? E : p, D, a.axisY.reversed ? p : E, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, q.fillOpacity);
                                b = q.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: p, x2: D, y2: E };
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if ((t[f].getTime ? (B = t[f].x.getTime()) : (B = t[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y)) {
                                ...
                                s = a.axisX.reversed ? (s + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + m) * p) << 0 : (s - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + m) * p) << 0;
                                var q = a.axisX.reversed ? (s - p) << 0 : (s + p) << 0,
                                    u;
                                0 <= t[f].y ? (u = k) : ((u = l), (l = k));
                                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, a.axisY.reversed ? l : u, a.axisX.reversed ? q : s, a.axisY.reversed ? u : l, a.axisX.reversed ? s : q, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: u, y1: s, x2: l, y2: q };
                                b = O(b);
                                w && ca(this._eventManager.ghostCtx, u, a.axisX.reversed ? q : s, l, a.axisX.reversed ? s : q, b, 0, null, !1, !1, !1, !1);
                                (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "bar",
                                        dataPoint: t[f],
                                        ...
                                        direction: 0 > t[f].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(u, l), y1: s, x2: Math.max(u, l), y2: q },
                                        color: b,
                                    });
                            }
                    }
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var x = (p - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    ...
                                    E;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    (s[b] = u[k].y + (s[b] ? s[b] : 0)), 0 < s[b] && ((E = f[b] ? f[b] : r), (f[b] = m = a.axisY.convertValueToPixel(s[b])));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (B[b] = u[k].y + (B[b] ? B[b] : 0)), (m = l[b] ? l[b] : r), (l[b] = E = a.axisY.convertValueToPixel(B[b]));
                                else if (((m = a.axisY.convertValueToPixel(u[k].y)), 0 <= u[k].y)) {
                                    var z = f[b] ? f[b] : 0;
                                    E = r + z;
                                    m += z;
                                    f[b] = z + (m - E);
                                } else (z = l[b] ? l[b] : 0), (E = m - z), (m = r - z), (l[b] = z + (m - E));
                                b = u[k].color ? u[k].color : q._colorSet[k % q._colorSet.length];
                                ca(c, a.axisY.reversed ? m : E, x, a.axisY.reversed ? E : m, D, b, 0, null, n, !1, !1, !1, q.fillOpacity);
                                b = q.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: E, y1: x, x2: m, y2: D };
                                b = O(b);
                                w && ca(this._eventManager.ghostCtx, E, x, m, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || q.indexLabel || u[k].indexLabelFormatter || q.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(E, m), y1: x, x2: Math.max(E, m), y2: D },
                                        color: b,
                                    });
                            }
                    }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var D = (p - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    E = (D + g) << 0;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                                    s[b] = x + (s[b] ? s[b] : 0);
                                    if (0 >= s[b]) continue;
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (B[b] = x + (B[b] ? B[b] : 0)), (m = l[b] ? l[b] : r), (l[b] = x = a.axisY.convertValueToPixel(B[b]));
                                else if (((m = a.axisY.convertValueToPixel(x)), 0 <= u[k].y)) {
                                    var z = f[b] ? f[b] : 0;
                                    x = r + z;
                                    m += z;
                                    a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x2 - m) && (m = e.x2);
                                    f[b] = z + (m - x);
                                } else (z = l[b] ? l[b] : 0), (x = m - z), (m = r - z), a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x1 - x) && (x = e.x1), (l[b] = z + (m - x));
                                b = u[k].color ? u[k].color : q._colorSet[k % q._colorSet.length];
                                ca(c, a.axisY.reversed ? m : x, D, a.axisY.reversed ? x : m, E, b, 0, null, n, !1, !1, !1, q.fillOpacity);
                                b = q.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: D, x2: m, y2: E };
                                b = O(b);
                                w && ca(this._eventManager.ghostCtx, x, D, m, E, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || q.indexLabel || u[k].indexLabelFormatter || q.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(x, m), y1: D, x2: Math.max(x, m), y2: E },
                                        color: b,
                                    });
                            }
                    }
        ...
        n.prototype.renderArea = function (a) {
            ...
            function b() {
                E &&
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (D = x) : 0 > a.axisY.viewportMaximum ? (D = s.y1) : 0 < a.axisY.viewportMinimum && (D = x),
                    f.lineTo(q, D),
                    f.lineTo(E.x, D),
                    f.closePath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var r = a.dataSeriesIndexes[p],
                        ...
                        t = g.dataPoints,
                        B = g.id;
                    this._eventManager.objectMap[B] = { objectType: "dataSeries", dataSeriesIndex: r };
                    B = O(B);
                    l.fillStyle = B;
                    B = [];
                    d = !0;
                    ...
                    if (0 < t.length) {
                        ...
                        for (var ea = !0; h < t.length; h++)
                            if (((n = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ea)))))
                                if ("number" !== typeof t[h].y) g.connectNullData || ea || d || b(), (ea = !0);
                                else {
                                    ...
                                    d || ea
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = q), (c = u), (q = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (q = d), (u = c), (E = m), (c = g.nullDataLineDashType), f.setLineDash(M)),
                                                f.lineTo(q, u),
                                                w && l.lineTo(q, u))
                                              : (f.beginPath(), f.moveTo(q, u), w && (l.beginPath(), l.moveTo(q, u)), (E = { x: q, y: u })),
                                          (ea = d = !1))
                                        : (f.lineTo(q, u), w && l.lineTo(q, u), 0 == h % 250 && b());
                                    m = { x: q, y: u };
                                    h < t.length - 1 &&
                                        (A !== (t[h].lineColor || v) || c !== (t[h].lineDashType || g.lineDashType)) &&
                                        (b(),
                                        (A = t[h].lineColor || v),
                                        (f.strokeStyle = A),
                                        f.setLineDash && (t[h].lineDashType ? ((c = t[h].lineDashType), f.setLineDash(I(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(Q))));
                                    var $ = g.dataPointIds[h];
                                    this._eventManager.objectMap[$] = { id: $, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: h, x1: q, y1: u };
                                    0 !== t[h].markerSize &&
                                        (0 < t[h].markerSize || 0 < g.markerSize) &&
                                        ((n = g.getMarkerProperties(h, q, u, f)), B.push(n), ($ = O($)), w && B.push({ x: q, y: u, ctx: l, type: n.type, size: n.size, color: $, borderColor: $, borderThickness: n.borderThickness }));
                                    (t[h].indexLabel || g.indexLabel || t[h].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: t[h], dataSeries: g, point: { x: q, y: u }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, color: z });
                                }
                        b();
                        Z.drawMarkers(B);
                    }
        ...
        n.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (q = h) : 0 > a.axisY.viewportMaximum ? (q = f.y1) : 0 < a.axisY.viewportMinimum && (q = h);
                    u = { x: c[0].x, y: c[0].y };
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    w && (e.lineTo(c[c.length - 1].x, q), e.lineTo(u.x, q), e.closePath(), e.fill());
                }
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = w ? this._preRenderCtx : c;
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (t = !1; r < p.length; r++)
                            if (((g = p[r].x.getTime ? p[r].x.getTime() : p[r].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !t)))))
                                if ("number" !== typeof p[r].y)
                                    0 < r &&
                                        !t &&
                                        (m.connectNullData
                                            ? b.setLineDash && 0 < n.length && (m.options.nullDataLineDashType || !p[r - 1].lineDashType) && ((n[n.length - 1].newLineDashArray = A), (z = m.nullDataLineDashType))
                                            : (d(), (n = []))),
                                        (t = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[M] = { id: M, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: r, x1: g, y1: t };
                                    n[n.length] = { x: g, y: t };
                                    r < p.length - 1 &&
                                        (E !== (p[r].lineColor || D) || z !== (p[r].lineDashType || m.lineDashType)) &&
                                        ((E = p[r].lineColor || D),
                                        (n[n.length - 1].newStrokeStyle = E),
                                        b.setLineDash && (p[r].lineDashType ? ((z = p[r].lineDashType), (n[n.length - 1].newLineDashArray = I(z, m.lineThickness))) : ((z = m.lineDashType), (n[n.length - 1].newLineDashArray = C))));
                                    if (0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < m.markerSize)) {
                                        var Q = m.getMarkerProperties(r, g, t, b);
                                        l.push(Q);
                                        M = O(M);
                                        w && l.push({ x: g, y: t, ctx: e, type: Q.type, size: Q.size, color: M, borderColor: M, borderThickness: Q.borderThickness });
                                    }
                                    (p[r].indexLabel || m.indexLabel || p[r].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: p[r], dataSeries: m, point: { x: g, y: t }, direction: 0 > p[r].y === a.axisY.reversed ? 1 : -1, color: x });
                                    t = !1;
                                }
                        d();
                        Z.drawMarkers(l);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (; h < t.length; h++)
                            if (((n = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))))) {
                                var $ = u;
                                "number" !== typeof t[h].y
                                    ...
                                    : ((q = a.axisX.convertValueToPixel(n)),
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      (g.options.nullDataLineDashType || (M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
                                                      ((d = q), (c = u), (q = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (q = d), (u = c), (E = m), (M = g.nullDataLineDashType), f.setLineDash(Q)),
                                                  f.lineTo(q, $),
                                                  f.lineTo(q, u),
                                                  w && (l.lineTo(q, $), l.lineTo(q, u)))
                                                : (f.beginPath(), f.moveTo(q, u), w && (l.beginPath(), l.moveTo(q, u)), (E = { x: q, y: u })),
                                            (c = d = !1))
                                          : (f.lineTo(q, $), w && l.lineTo(q, $), f.lineTo(q, u), w && l.lineTo(q, u), 0 == h % 250 && b()),
                                      (m = { x: q, y: u }),
                                      h < t.length - 1 &&
                                          (A !== (t[h].lineColor || v) || M !== (t[h].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (A = t[h].lineColor || v),
                                          (f.strokeStyle = A),
                                          f.setLineDash && (t[h].lineDashType ? ((M = t[h].lineDashType), f.setLineDash(I(M, g.lineThickness))) : ((M = g.lineDashType), f.setLineDash(ea)))),
                                      (n = g.dataPointIds[h]),
                                      (this._eventManager.objectMap[n] = { id: n, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: h, x1: q, y1: u }),
                                      0 !== t[h].markerSize &&
                                          (0 < t[h].markerSize || 0 < g.markerSize) &&
                                          (($ = g.getMarkerProperties(h, q, u, f)), B.push($), (n = O(n)), w && B.push({ x: q, y: u, ctx: l, type: $.type, size: $.size, color: n, borderColor: n, borderThickness: $.borderThickness })),
                                      (t[h].indexLabel || g.indexLabel || t[h].indexLabelFormatter || g.indexLabelFormatter) &&
                                          this._indexLabels.push({ chartType: "stepArea", dataPoint: t[h], dataSeries: g, point: { x: q, y: u }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, color: z }));
                            }
                        b();
                        Z.drawMarkers(B);
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
                    var E = a.dataSeriesIndexes[D],
                        ...
                        v = z.dataPoints;
                    z.dataPointIndexes = [];
                    for (r = 0; r < v.length; r++) (E = v[r].x.getTime ? v[r].x.getTime() : v[r].x), (z.dataPointIndexes[E] = r), e[E] || (m.push(E), (e[E] = !0));
                    m.sort(Ra);
                }
                for (D = 0; D < a.dataSeriesIndexes.length; D++) {
                    ...
                    k = [];
                    r = z.id;
                    this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: E };
                    r = O(r);
                    n.fillStyle = r;
                    if (0 < m.length) {
                        var e = z._colorSet[0],
                        ...
                        for (var $ = !0, r = 0; r < m.length; r++) {
                            var f = m[r],
                                ia = null,
                                ia = 0 <= z.dataPointIndexes[f] ? v[z.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !$))))
                                if ("number" !== typeof ia.y) z.connectNullData || $ || y || d(), ($ = !0);
                                else {
                                    ...
                                    y || $
                                        ? (!y && z.connectNullData
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((y = k.pop()), (x = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), (x = z.nullDataLineDashType), b.setLineDash(Q)),
                                                b.lineTo(g, t),
                                                w && n.lineTo(g, t))
                                              : (b.beginPath(), b.moveTo(g, t), w && (n.beginPath(), n.moveTo(g, t))),
                                          ($ = y = !1))
                                        : (b.lineTo(g, t), w && n.lineTo(g, t), 0 == r % 250 && (d(), b.moveTo(g, t), w && n.moveTo(g, t), k.push({ x: g, y: q - oa })));
                                    u = { x: g, y: t };
                                    r < v.length - 1 &&
                                        (M !== (v[r].lineColor || A) || x !== (v[r].lineDashType || z.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, t),
                                        k.push({ x: g, y: q - oa }),
                                        (M = v[r].lineColor || A),
                                        (b.strokeStyle = M),
                                        b.setLineDash && (v[r].lineDashType ? ((x = v[r].lineDashType), b.setLineDash(I(x, z.lineThickness))) : ((x = z.lineDashType), b.setLineDash(ea))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                        var C = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: E, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: t };
                                    }
                                    0 <= z.dataPointIndexes[f] &&
                                        0 !== ia.markerSize &&
                                        (0 < ia.markerSize || 0 < z.markerSize) &&
                                        ((oa = z.getMarkerProperties(z.dataPointIndexes[f], g, t, b)),
                                        l.push(oa),
                                        (f = O(C)),
                                        w && l.push({ x: g, y: t, ctx: n, type: oa.type, size: oa.size, color: f, borderColor: f, borderThickness: oa.borderThickness }));
                                    (ia.indexLabel || z.indexLabel || ia.indexLabelFormatter || z.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: ia, dataSeries: z, point: { x: g, y: t }, direction: 0 > v[r].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, t);
        ...
        n.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (D = 0; D < a.dataSeriesIndexes.length; D++) {
                    ...
                    n = !0;
                    e = z.id;
                    this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: E };
                    e = O(e);
                    x.fillStyle = e;
                    k = [];
                    if (0 < m.length) {
                        ...
                        for (var $ = !0, r = 0; r < m.length; r++) {
                            var f = m[r],
                                ...
                                ia = 0 <= z.dataPointIndexes[f] ? v[z.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !$))))
                                if ("number" !== typeof ia.y) z.connectNullData || $ || n || d(), ($ = !0);
                                else {
                                    var oa;
                                    ...
                                    n || $
                                        ? (!n && z.connectNullData
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((n = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(q.x, q.y), k.push(u), k.push(n), (u = z.nullDataLineDashType), b.setLineDash(Q)),
                                                b.lineTo(g, t),
                                                w && x.lineTo(g, t))
                                              : (b.beginPath(), b.moveTo(g, t), w && (x.beginPath(), x.moveTo(g, t))),
                                          ($ = n = !1))
                                        : (b.lineTo(g, t), w && x.lineTo(g, t), 0 == r % 250 && (d(), b.moveTo(g, t), w && x.moveTo(g, t), k.push({ x: g, y: y - na })));
                                    q = { x: g, y: t };
                                    r < v.length - 1 &&
                                        (M !== (v[r].lineColor || A) || u !== (v[r].lineDashType || z.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, t),
                                        k.push({ x: g, y: y - na }),
                                        (M = v[r].lineColor || A),
                                        (b.strokeStyle = M),
                                        b.setLineDash && (v[r].lineDashType ? ((u = v[r].lineDashType), b.setLineDash(I(u, z.lineThickness))) : ((u = z.lineDashType), b.setLineDash(C))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                        var G = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: E, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: t };
                                    }
                                    0 <= z.dataPointIndexes[f] &&
                                        0 !== ia.markerSize &&
                                        (0 < ia.markerSize || 0 < z.markerSize) &&
                                        ((na = z.getMarkerProperties(r, g, t, b)), s.push(na), (f = O(G)), w && s.push({ x: g, y: t, ctx: x, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness }));
                                    (ia.indexLabel || z.indexLabel || ia.indexLabelFormatter || z.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ia, dataSeries: z, point: { x: g, y: t }, direction: 0 > v[r].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, t);
        ...
        n.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                    for (var m = a.dataSeriesIndexes[k], p = this.data[m], r = p.dataPoints, g = 0, e = 0; e < r.length; e++)
                        (f = r[e].getTime ? (f = r[e].x.getTime()) : (f = r[e].x)), f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z || ((g = r[e].z), g > s && (s = g), g < h && (h = g));
                for (var t = 25 * Math.PI, q = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, t), k = 0; k < a.dataSeriesIndexes.length; k++)
                    if (((m = a.dataSeriesIndexes[k]), (p = this.data[m]), (r = p.dataPoints), 0 < r.length))
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < r.length; e++)
                            if (((f = r[e].getTime ? (f = r[e].x.getTime()) : (f = r[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y)) {
                                ...
                                var g = r[e].z,
                                    n = 2 * Math.max(Math.sqrt((s === h ? q / 2 : t + ((q - t) / (s - h)) * (g - h)) / Math.PI) << 0, 1),
                                    g = p.getMarkerProperties(e, c);
                                g.size = n;
                                c.globalAlpha = p.fillOpacity;
                                Z.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness);
                                c.globalAlpha = 1;
                                ...
                                n = O(u);
                                w && Z.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness);
                                (r[e].indexLabel || p.indexLabel || r[e].indexLabelFormatter || p.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "bubble",
                                        dataPoint: r[e],
                                        dataSeries: p,
                    ...
                    if (0 < m.length) {
                        ...
                        for (var p = 0, r = 0, e = 0; e < m.length; e++)
                            if (((f = m[e].getTime ? (f = m[e].x.getTime()) : (f = m[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y)) {
                                ...
                                Z.drawMarker(g.x, g.y, g.ctx, g.type, g.size, g.color, g.borderColor, g.borderThickness);
                                c.globalAlpha = 1;
                                (Math.sqrt((p - f) * (p - f) + (r - l) * (r - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ((p = k.dataPointIds[e]),
                                    (this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: l }),
                                    (p = O(p)),
                                    w && Z.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
        ...
        n.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                t = this.options.dataPointWidth ? this.dataPointWidth : (0.7 * l.width * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range))) << 0;
                        ...
                        for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)
                            if (
                                ...
                                var D = (h - t / 2) << 0,
                                    ...
                                    v = 0 === z % 2 ? 0 : 0.5,
                                    A = u.dataPointIds[s];
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: da, dataPointIndex: s, x1: D, y1: k, x2: E, y2: m, x3: h, y3: p, x4: h, y4: r, borderThickness: z, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = z;
                                ...
                                "candlestick" === u.type
                                    ? (c.moveTo(h - v, m),
                                      ...
                                      c.lineTo(h - v, p),
                                      c.stroke(),
                                      ca(c, D, Math.min(k, r), E, Math.max(k, r), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, z, e, x, x, !1, !1, u.fillOpacity),
                                      w &&
                                          ((e = O(A)),
                                          (b.strokeStyle = e),
                                          b.moveTo(h - v, m),
                                          ...
                                          b.lineTo(h - v, p),
                                          b.stroke(),
                                          ca(b, D, Math.min(k, r), E, Math.max(k, r), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === u.type &&
                                      (c.moveTo(h - v, m),
                                      c.lineTo(h - v, p),
                                      c.stroke(),
                                      ...
                                      w &&
                                          ...
                                          b.lineTo(E, r),
                                          b.stroke()));
                                (y[s].indexLabel || u.indexLabel || y[s].indexLabelFormatter || u.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: u.type,
                                        dataPoint: y[s],
                                        dataSeries: u,
                                        ...
                                        direction: 1,
                                        bounds: { x1: D, y1: Math.min(m, p), x2: E, y2: Math.max(m, p) },
                                        color: e,
                                    });
                            }
                }
        ...
        n.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = !1, n = !!a.axisY.reversed, da = 0; da < a.dataSeriesIndexes.length; da++) {
                    var u = a.dataSeriesIndexes[da],
                        y = this.data[u],
                        x = y.dataPoints;
                    if (0 < x.length)
                        for (var D = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (
                                ...
                                var E = (s - t / 2) << 0,
                                    ...
                                    Q = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : v,
                                    C = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                                    $ = q(x[l].whiskerLength) ? (q(y.options.whiskerLength) ? t : y.whiskerLength) : x[l].whiskerLength,
                                    $ = "number" === typeof $ ? (0 >= $ ? 0 : $ >= t ? t : $) : "string" === typeof $ ? ((parseInt($) * t) / 100 > t ? t : (parseInt($) * t) / 100) : t,
                                    ...
                                    na = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : v,
                                    ...
                                    J = "number" === typeof x[l].lineThickness ? x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : v,
                                ...
                                c.save();
                                0 < na &&
                                    (c.beginPath(), (c.strokeStyle = oa), (c.lineWidth = na), c.setLineDash && c.setLineDash(I(F, na)), c.moveTo(s - G, k), c.lineTo(s - G, h), c.stroke(), c.moveTo(s - G, p), c.lineTo(s - G, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(v, 4);
                                c.beginPath();
                                ca(c, E, Math.min(r, k), z, Math.max(k, r), T, 0, e, n ? D : !1, n ? !1 : D, !1, !1, ua);
                                c.beginPath();
                                ca(c, E, Math.min(m, r), z, Math.max(r, m), P, 0, e, n ? !1 : D, n ? D : !1, !1, !1, ua);
                                c.beginPath();
                                c.lineWidth = v;
                                c.strokeStyle = e;
                                c.rect(E - A, Math.min(k, m) - A, z - E + 2 * A, Math.max(k, m) - Math.min(k, m) + 2 * A);
                                c.stroke();
                                c.save();
                                0 < J && (c.beginPath(), (c.globalAlpha = 1), c.setLineDash && c.setLineDash(I(R, J)), (c.strokeStyle = K), (c.lineWidth = J), c.moveTo(E, r - L), c.lineTo(z, r - L), c.stroke());
                                c.restore();
                                c.save();
                                0 < Q &&
                                    (c.beginPath(),
                                ...
                                w &&
                                    ...
                                    (b.strokeStyle = e),
                                    (b.lineWidth = na),
                                    0 < na && (b.moveTo(s - A - G, k), b.lineTo(s - A - G, Math.max(h, p)), b.stroke(), b.moveTo(s - A - G, Math.min(h, p)), b.lineTo(s - A - G, m), b.stroke()),
                                    ca(b, E, Math.max(k, m), z, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                                    0 < Q && (b.beginPath(), (b.lineWidth = Q), b.moveTo(s + $ / 2, p - ia), b.lineTo(s - $ / 2, p - ia), b.stroke(), b.moveTo(s + $ / 2, h + ia), b.lineTo(s - $ / 2, h + ia), b.stroke()));
                                (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter || y.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 1,
                                        bounds: { x1: E, y1: Math.min(h, p), x2: z, y2: Math.max(h, p) },
                                        color: e,
                                    });
                            }
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var p = a.dataSeriesIndexes[m],
                        ...
                        g = r.dataPoints;
                    if (0 < g.length)
                        for (var t = 5 < k && r.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                (g[f].getTime ? (h = g[f].x.getTime()) : (h = g[f].x),
                                !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !q(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1])
                            ) {
                                ...
                                var n = a.axisX.reversed ? (b + (a.plotType.totalDataSeries * k) / 2 - (a.previousDataSeriesCount + m) * k) << 0 : (b - (a.plotType.totalDataSeries * k) / 2 + (a.previousDataSeriesCount + m) * k) << 0,
                                    ...
                                    b = g[f].color ? g[f].color : r._colorSet[f % r._colorSet.length];
                                if (l > s) {
                                    var u = l;
                                    l = s;
                                    s = u;
                                ...
                                u = r.dataPointIds[f];
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: n, y1: l, x2: da, y2: s };
                                ca(c, a.axisX.reversed ? da : n, l, a.axisX.reversed ? n : da, s, b, 0, b, t, t, !1, !1, r.fillOpacity);
                                b = O(u);
                                w && ca(this._eventManager.ghostCtx, a.axisX.reversed ? da : n, l, a.axisX.reversed ? n : da, s, b, 0, null, !1, !1, !1, !1);
                                if (g[f].indexLabel || r.indexLabel || g[f].indexLabelFormatter || r.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "rangeColumn",
                                        dataPoint: g[f],
                                        dataSeries: r,
                                        indexKeyword: 0,
                                        point: { x: n + (da - n) / 2, y: g[f].y[1] >= g[f].y[0] ? s : l },
                                        direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                                        bounds: { x1: n, y1: Math.min(l, s), x2: da, y2: Math.max(l, s) },
                                        color: b,
                                    }),
                                        this._indexLabels.push({
                                            chartType: "rangeColumn",
                                            ...
                                            dataSeries: r,
                                            indexKeyword: 1,
                                            point: { x: n + (da - n) / 2, y: g[f].y[1] >= g[f].y[0] ? l : s },
                                            direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                                            bounds: { x1: n, y1: Math.min(l, s), x2: da, y2: Math.max(l, s) },
                                            color: b,
                                        });
        ...
        n.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var da = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/gi) || !this.data[u].visible || (this.data[u].type.match(/(stacked)/gi) && da) || da++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y],
                        D = this.data[x],
                        v = D.dataPoints,
                        z = q(D._linkedSeries) ? !1 : D._linkedSeries.type.match(/(bar|column)/gi) && D._linkedSeries.visible ? !0 : !1,
                        A = 0;
                    if (z)
                        for (e = D._linkedSeries.id, u = 0; u < e; u++)
                            !this.data[u].type.match(/(bar|column)/gi) || !this.data[u].visible || (this.data[u].type.match(/(stacked)/gi) && A) || (this.data[u].type.match(/(range)/gi) && (f = !0), A++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? da : 1))) << 0 : 0.3 * this.width;
                    f &&
                        (s = this.options.dataPointMaxWidth
                            ...
                            ? this.dataPointWidth
                            : b
                            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? da : 1))) << 0
                            : 0.03 * this.width);
                    u = this.options.dataPointWidth ? this.dataPointWidth : (0.9 * (((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range))) / (z ? da : 1))) << 0;
                    ...
                    if (0 < v.length)
                        for (var F = D._colorSet, s = 0; s < v.length; s++) {
                            var e = (D.lineColor = D.options.color ? D.options.color : F[0]),
                                M = {
                                    color: v[s].whiskerColor ? v[s].whiskerColor : v[s].color ? (D.whiskerColor ? D.whiskerColor : v[s].color) : D.whiskerColor ? D.whiskerColor : e,
                                    thickness: q(v[s].whiskerThickness) ? D.whiskerThickness : v[s].whiskerThickness,
                                    dashType: v[s].whiskerDashType ? v[s].whiskerDashType : D.whiskerDashType,
                                    length: q(v[s].whiskerLength) ? (q(D.options.whiskerLength) ? u : D.options.whiskerLength) : v[s].whiskerLength,
                                    trimLength: q(v[s].whiskerLength) ? (q(D.options.whiskerLength) ? 50 : 0) : 0,
                                };
                            ...
                            var Q = {
                                color: v[s].stemColor ? v[s].stemColor : v[s].color ? (D.stemColor ? D.stemColor : v[s].color) : D.stemColor ? D.stemColor : e,
                                thickness: v[s].stemThickness ? v[s].stemThickness : D.stemThickness,
                                dashType: v[s].stemDashType ? v[s].stemDashType : D.stemDashType,
                            };
                            Q.thickness = "number" === typeof Q.thickness ? (0 > Q.thickness ? 0 : Math.round(Q.thickness)) : 2;
                            v[s].getTime ? (t = v[s].x.getTime()) : (t = v[s].x);
                            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !q(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
                                ...
                                b ? (p = ea) : (g = ea);
                                b
                                    ? ((r = a.axisX.reversed ? (k + ((z ? da : 1) * u) / 2 - (z ? A - 1 : 0) * u) << 0 : (k - ((z ? da : 1) * u) / 2 + (z ? A - 1 : 0) * u) << 0), (g = a.axisX.reversed ? (r - u) << 0 : (r + u) << 0))
                                    : ((m = a.axisX.reversed ? (h + ((z ? da : 1) * u) / 2 - (z ? A - 1 : 0) * u) << 0 : (h - ((z ? da : 1) * u) / 2 + (z ? A - 1 : 0) * u) << 0), (p = a.axisX.reversed ? (m - u) << 0 : (m + u) << 0));
                                !b && r > g && ((ea = r), (r = g), (g = ea));
                                b && m > p && ((ea = m), (m = p), (p = ea));
                                ea = D.dataPointIds[s];
                                ...
                                C(c, Math.min(m, p), Math.min(r, g), Math.max(p, m), Math.max(g, r), e, M, Q, b);
                                w && C(this._eventManager.ghostCtx, m, r, p, g, e, M, Q, b);
                                if (v[s].indexLabel || D.indexLabel || v[s].indexLabelFormatter || D.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: v[s],
                                        dataSeries: D,
                                        indexKeyword: 0,
                                        point: { x: b ? (v[s].y[1] >= v[s].y[0] ? m : p) : m + (p - m) / 2, y: b ? r + (g - r) / 2 : v[s].y[1] >= v[s].y[0] ? g : r },
                                        direction: v[s].y[1] >= v[s].y[0] ? -1 : 1,
                                        bounds: { x1: b ? Math.min(m, p) : m, y1: b ? r : Math.min(r, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(r, g) },
                                        color: e,
                                        axisSwapped: b,
                                    }),
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: D,
                                            indexKeyword: 1,
                                            point: { x: b ? (v[s].y[1] >= v[s].y[0] ? p : m) : m + (p - m) / 2, y: b ? r + (g - r) / 2 : v[s].y[1] >= v[s].y[0] ? r : g },
                                            direction: v[s].y[1] >= v[s].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(m, p) : m, y1: b ? r : Math.min(r, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(r, g) },
                                            color: e,
                                            axisSwapped: b,
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if (
                                ...
                                !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !q(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1])
                            ) {
                                ...
                                l > s && ((b = l), (l = s), (s = b));
                                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0, null, n, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: l, y1: h, x2: s, y2: v };
                                b = O(b);
                                w && ca(this._eventManager.ghostCtx, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0, null, !1, !1, !1, !1);
                                if (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "rangeBar",
                                        dataPoint: t[f],
                                        dataSeries: g,
                                        indexKeyword: 0,
                                        point: { x: t[f].y[1] >= t[f].y[0] ? l : s, y: h + (v - h) / 2 },
                                        direction: t[f].y[1] >= t[f].y[0] ? -1 : 1,
                                        bounds: { x1: Math.min(l, s), y1: h, x2: Math.max(l, s), y2: v },
                                        color: b,
                                    }),
                                        this._indexLabels.push({
                                            chartType: "rangeBar",
                                            ...
                                            dataSeries: g,
                                            indexKeyword: 1,
                                            point: { x: t[f].y[1] >= t[f].y[0] ? s : l, y: h + (v - h) / 2 },
                                            direction: t[f].y[1] >= t[f].y[0] ? 1 : -1,
                                            bounds: { x1: Math.min(l, s), y1: h, x2: Math.max(l, s), y2: v },
                                            color: b,
                                        });
                                    ...
                                    r || M
                                        ? (m.connectNullData && !r
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((h[h.length - 1].newLineDashArray = C), (z = m.nullDataLineDashType), b.setLineDash(A)),
                                                b.lineTo(t, q),
                                                w && e.lineTo(t, q),
                                                h.push({ x: t, y1: q, y2: n }))
                                              : (b.beginPath(), b.moveTo(t, q), (y = { x: t, y: q }), (h = []), h.push({ x: t, y1: q, y2: n }), w && (e.beginPath(), e.moveTo(t, q))),
                                          (M = r = !1))
                                        : (b.lineTo(t, q), h.push({ x: t, y1: q, y2: n }), w && e.lineTo(t, q), 0 == g % 250 && d());
                                    u = m.dataPointIds[g];
                                    this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: t, y1: q, y2: n };
                                    g < p.length - 1 &&
                                        (E !== (p[g].lineColor || v) || z !== (p[g].lineDashType || m.lineDashType)) &&
                                        (d(),
                                        (E = p[g].lineColor || v),
                                        ...
                                        b.setLineDash &&
                                            (p[g].lineDashType
                                                ? ((z = p[g].lineDashType), (h[h.length - 1].newLineDashArray = I(z, m.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                                                : ((z = m.lineDashType), (h[h.length - 1].newLineDashArray = C), b.setLineDash(C))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < m.markerSize)) {
                                        var Q = m.getMarkerProperties(g, t, n, b);
                                        f.push(Q);
                                        var ea = O(u);
                                        w && f.push({ x: t, y: n, ctx: e, type: Q.type, size: Q.size, color: ea, borderColor: ea, borderThickness: Q.borderThickness });
                                        Q = m.getMarkerProperties(g, t, q, b);
                                        f.push(Q);
                                        ea = O(u);
                                        w && f.push({ x: t, y: q, ctx: e, type: Q.type, size: Q.size, color: ea, borderColor: ea, borderThickness: Q.borderThickness });
                                    }
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 0, point: { x: t, y: q }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: x }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: p[g],
                                                dataSeries: m,
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
                            if (q[g].newStrokeStyle || q[g].newLineDashArray)
                                b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), q[g].newStrokeStyle && (b.strokeStyle = q[g].newStrokeStyle), q[g].newLineDashArray && b.setLineDash(q[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                        }
                        d = v(q, 2);
                        b.moveTo(d[0].x, d[0].y);
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (g = !1; p < m.length; p++)
                            if (((r = m[p].x.getTime ? m[p].x.getTime() : m[p].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: p, x1: r, y1: g, y2: t };
                                    q[q.length] = { x: r, y: g };
                                    n[n.length] = { x: r, y: t };
                                    p < m.length - 1 &&
                                        (x !== (m[p].lineColor || y) || D !== (m[p].lineDashType || k.lineDashType)) &&
                                        ((x = m[p].lineColor || y),
                                        (q[q.length - 1].newStrokeStyle = x),
                                        b.setLineDash && (m[p].lineDashType ? ((D = m[p].lineDashType), (q[q.length - 1].newLineDashArray = I(D, k.lineThickness))) : ((D = k.lineDashType), (q[q.length - 1].newLineDashArray = E))));
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        var C = k.getMarkerProperties(p, r, g, b);
                                        f.push(C);
                                        var M = O(A);
                                        w && f.push({ x: r, y: g, ctx: e, type: C.type, size: C.size, color: M, borderColor: M, borderThickness: C.borderThickness });
                                        C = k.getMarkerProperties(p, r, t, b);
                                        f.push(C);
                                        M = O(A);
                                        w && f.push({ x: r, y: t, ctx: e, type: C.type, size: C.size, color: M, borderColor: M, borderThickness: C.borderThickness });
                                    }
                                    if (m[p].indexLabel || k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 0, point: { x: r, y: g }, direction: m[p].y[0] <= m[p].y[1] ? -1 : 1, color: u }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 1, point: { x: r, y: t }, direction: m[p].y[0] <= m[p].y[1] ? 1 : -1, color: u });
                                    g = !1;
                                } else
                                    0 < p &&
                                        !g &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < q.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType) && ((q[q.length - 1].newLineDashArray = z), (D = k.nullDataLineDashType))
                                            : (d(E, y), (q = []), (n = []))),
                                        (g = !0);
                        d(E, y);
                        Z.drawMarkers(f);
        ...
        n.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var x = 5 < r && n.bevelEnabled ? !0 : !1, D = !1, A = null, z = null, l = 0; l < v.length; l++)
                            if ((v[l].getTime ? (m = v[l].x.getTime()) : (m = v[l].x), "number" !== typeof v[l].y)) {
                                if (0 < l && !D && n.connectNullData) var C = n.options.nullDataLineDashType || !v[l - 1].lineDashType ? n.nullDataLineDashType : v[l - 1].lineDashType;
                                D = !0;
                            } else {
                                h = a.axisX.convertValueToPixel(m);
                                q = 0 === n.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSum);
                                k = 0 === n.dataPointEOs[l].cumulativeSumYStartValue ? p : a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSumYStartValue);
                                h = a.axisX.reversed ? (h + (a.plotType.totalDataSeries * r) / 2 - (a.previousDataSeriesCount + g) * r) << 0 : (h - (a.plotType.totalDataSeries * r) / 2 + (a.previousDataSeriesCount + g) * r) << 0;
                                var F = a.axisX.reversed ? (h - r) << 0 : (h + r) << 0;
                                q > k && ((e = q), (q = k), (k = e));
                                a.axisY.reversed && ((e = q), (q = k), (k = e));
                                e = n.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: l, x1: h, y1: q, x2: F, y2: k };
                                var M = v[l].color ? v[l].color : 0 < v[l].y ? n.risingColor : n.fallingColor;
                                ca(c, a.axisX.reversed ? F : h, a.axisY.reversed ? k : q, a.axisX.reversed ? h : F, a.axisY.reversed ? q : k, M, 0, M, x, x, !1, !1, n.fillOpacity);
                                e = O(e);
                                w && ca(this._eventManager.ghostCtx, a.axisX.reversed ? F : h, q, a.axisX.reversed ? h : F, k, e, 0, null, !1, !1, !1, !1);
                                var Q,
                                    M = h;
                                Q =
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(M, Q - y),
                                    0 < u && c.stroke(),
                                    w && (b.beginPath(), b.moveTo(A, z - y), b.lineTo(M, Q - y), 0 < u && b.stroke()));
                                D = !1;
                                A = F;
                                z = 0 < v[l].y ? q : k;
                                ...
                                (v[l].indexLabel || n.indexLabel || v[l].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: h, y1: Math.min(q, k), x2: F, y2: Math.max(q, k) },
                                        color: e,
                                    });
                            }
                }
        ...
        var ra = function (a, d, c, b, e, f, l, h, q) {
            if (!(0 > c)) {
                ...
                "pie" === e
                    ...
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= q && a.arc(d.x, d.y, q * c, l, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
        n.prototype.renderPie = function (a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        if (k.indexLabelFormatter || f.indexLabelFormatter) s = { chart: n.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent };
                        ...
                        h.indexLabelLineThickness = q(f.indexLabelLineThickness) ? k.indexLabelLineThickness : f.indexLabelLineThickness;
                        ...
                        h.indexLabelFontSize = q(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize;
                        ...
                        h.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * r.width;
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        ra(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius);
                    }
                }
                a = n.plotArea.ctx;
                a.save();
                    ...
                    (c = g[b]),
                        c.indexLabelText &&
                            ...
                            "inside" !== c.indexLabelPlacement &&
                                ...
                                a.setLineDash && a.setLineDash(I(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                                a.beginPath(),
                                a.moveTo(d, e),
                    ...
                    0 > c
                        ? ((h = "right" === p.hemisphere ? s : r),
                          ...
                          null !== h &&
                              ...
                              c - s < t && ((k = -s), (h = f(h, k, d + 1)), +h.toFixed(y) > +k.toFixed(y) && (l = c > t ? -(c - t) : -(s - (h - k))))))
                        : 0 < c &&
                          ...
                          null !== h &&
                              ...
                              c - s < t && ((k = s), (h = f(h, k, d + 1)), +h.toFixed(y) < +k.toFixed(y) && (l = c > t ? c - t : s - (k - h)))));
                    l &&
                        ((d = p.indexLabelTextBlock.y + l),
                        (c = 0),
                        (c = "right" === p.hemisphere ? x.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2)) : x.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2))),
                        ...
                        (p.indexLabelAngle = Math.atan2(p.indexLabelTextBlock.y - x.y, p.indexLabelTextBlock.x - x.x)));
                }
                return l;
            }
            function l() {
                ...
                for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || (!k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= C)) l = !1;
                    l && (z -= d);
                    d = 0;
                        ...
                        for (var s, q, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var D = 0,
                                    D = b(s, q) - t;
                                if (0 > D) {
                                    for (var A = (q = 0), E = 0; E < m.length; E++) E !== a && g[E].hemisphere === h.hemisphere && (g[E].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? q++ : A++);
                                    q = (D / (q + A || 1)) * A;
                                    var A = -1 * (D - q),
                                        I = (E = 0);
                                    "right" === h.hemisphere
                                        ? ((E = f(a, q)), (A = -1 * (D - E)), (I = f(u, A)), +I.toFixed(y) < +A.toFixed(y) && +E.toFixed(y) <= +q.toFixed(y) && f(a, -(A - I)))
                                        : ((E = f(u, q)), (A = -1 * (D - E)), (I = f(a, A)), +I.toFixed(y) < +A.toFixed(y) && +E.toFixed(y) <= +q.toFixed(y) && f(u, -(A - I)));
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++)
                            (h = g[a]), (w = "pie" === k.type ? 0.7 * z : 0.8 * z), (u = x.x + w * Math.cos(h.midAngle)), (q = x.y + w * Math.sin(h.midAngle)), (h.indexLabelTextBlock.x = u), (h.indexLabelTextBlock.y = q);
                    for (a = 0; a < m.length; a++)
                        if (((h = g[a]), (u = h.indexLabelTextBlock.measureText()), 0 !== u.height && 0 !== u.width))
                            (u = u = 0),
                                "right" === h.hemisphere ? ((u = r.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p)), (u *= -1)) : (u = r.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p)),
                                0 < u &&
                                    (!l &&
                                        h.indexLabelText &&
                                        ((q = "right" === h.hemisphere ? r.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - r.x1),
                                        0.3 * h.indexLabelTextBlock.maxWidth > q ? (h.indexLabelText = "") : (h.indexLabelTextBlock.maxWidth = 0.85 * q),
                                        0.3 * h.indexLabelTextBlock.maxWidth < q && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)),
                                    Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - x.y) < z || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - x.y) < z) &&
                                    ((u /= Math.abs(Math.cos(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)),
                                (u = u = 0),
                                0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                                    ? ((u = r.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5)), (u *= -1))
                                    : (u = r.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5)),
                                0 < u &&
                                    (!l && h.indexLabelText && ((q = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, u * q) && f(a, 2 * q)),
                                    Math.abs(h.indexLabelTextBlock.x - x.x) < z && ((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
                                ...
                                if (null !== l) {
                                    ...
                                    if ((r = 0 > D)) {
                                        ...
                                        var q = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height / 2,
                                            n = s.indexLabelTextBlock.y + s.indexLabelTextBlock.height / 2,
                                        ...
                                        r = s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || r > u + p || q > B + p || n < t - p ? !1 : !0;
                                    }
                                    r ? (0 > a && (a = k), l !== a && ((c = l), (d += -D)), 0 === k % Math.max(m.length / 10, 3) && (f = !0)) : (f = !0);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== D) {
                    ...
                    var z = "inside" !== k.indexLabelPlacement && a ? (0.75 * Math.min(r.width, r.height)) / 2 : (0.92 * Math.min(r.width, r.height)) / 2;
                    k.radius && (z = Ta(k.radius, z));
                    var C = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ta(k.innerRadius, z) : 0.7 * z;
                    k.radius = z;
                    "doughnut" === k.type && (k.innerRadius = C);
                    var F = Math.min(C / z, (z - 1) / z);
                    this.pieDoughnutClickHandler = function (a) {
                        n.isAnimating ||
                            (!q(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick) ||
                            ((a = a.dataPoint),
                    ...
                    this._animator.animate(
                        ...
                        function (a) {
                            ...
                            for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                                ...
                                e > d && ra(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                                if (f) break;
                            }
                            h();
                            n.dispatchEvent("dataAnimationIterationEnd", { chart: n });
        ...
        n.prototype.renderFunnel = function (a) {
            function d() {
                ...
                if (0 === a) return -1;
                for (c = b[0] = 0; c < y.length; c++) b.push((Math.abs(y[c].y) * C) / a);
                return b;
            }
            function c() {
                var a = U,
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, m, p, r, s, n, t, B = [], x = [], v = { percent: null, total: null }, D = null, z = 0; z < y.length; z++)
                        (t = S[z]), (t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2), (t = g(t).x2 + 1), (B[z] = J - t - W);
                    t = 0.5 * W;
                    for (var z = 0, E = y.length - 1; z < y.length || 0 <= E; z++, E--) {
                        ...
                        f = q(b.indexLabelFontSize) ? u.indexLabelFontSize : b.indexLabelFontSize;
                        ...
                        r = "undefined" !== typeof b.indexLabelWrap ? b.indexLabelWrap : "undefined" !== typeof u.indexLabelWrap ? u.indexLabelWrap : !0;
                        s = u.dataPointIds[z];
                        A._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataPointIndex: z, dataSeriesIndex: 0, funnelSection: S[u.reversed ? y.length - 1 - z : z] };
                        "inside" === u.indexLabelPlacement &&
                            ((B[z] = z !== ca ? (u.reversed ? S[z].x2 - S[z].x1 : S[z].x3 - S[z].x4) : S[z].x3 - S[z].x6),
                            20 > B[z] && ((B[z] = z !== ca ? (u.reversed ? S[z].x3 - S[z].x4 : S[z].x2 - S[z].x1) : S[z].x2 - S[z].x1), (B[z] /= 2)));
                        s = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : B[z];
                        if (s > B[z] || 0 > s) s = B[z];
                        x[z] = "inside" === u.indexLabelPlacement ? S[z].height : !1;
                        v = A.getPercentAndTotal(u, b);
                        if (u.indexLabelFormatter || b.indexLabelFormatter) D = { chart: A.options, dataSeries: u, dataPoint: b, total: v.total, percent: v.percent };
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, k = J - X - W / 2, k = u.options.indexLabelMaxWidth ? (u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth) : k, l = H.length - 1; 0 <= l; l--) {
                    g = y[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        (a = S[l]),
                            ...
                            u.reversed
                                ? (H[l].textBlock.y + H[l].height > pa + D && (H[l].textBlock.y = pa + D - H[l].height), H[l].textBlock.y < ua - D && (H[l].textBlock.y = ua - D))
                                : (H[l].textBlock.y < pa - D && (H[l].textBlock.y = pa - D), H[l].textBlock.y + H[l].height > ua + D && (H[l].textBlock.y = ua + D - H[l].height));
            }
            function f() {
                var a, b, c, d;
                    ...
                    for (var e = 0; e < S.length; e++)
                        0 == H[e].textBlock.text.length
                            ...
                            : ((a = S[e]),
                              ...
                              u.reversed
                                  ? (H[e].textBlock.y + H[e].height > pa + D && (H[e].textBlock.y = pa + D - H[e].height), H[e].textBlock.y < ua - D && (H[e].textBlock.y = ua - D))
                                  : (H[e].textBlock.y < pa - D && (H[e].textBlock.y = pa - D), H[e].textBlock.y + H[e].height > ua + D && (H[e].textBlock.y = ua + D - H[e].height)));
                else
            ...
            function l() {
                    ...
                    for (var l, h = 1; h < k; h++) {
                        ...
                        for (var s = H.length - 1; 0 <= s; s--)
                            !H[s].isDirty &&
                                ...
                                ((l = r(s)), !(l >= H.length - 1) && H[s].textBlock.y + H[s].height + ba > H[l].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1));
                    }
                    for (l = S.length - 1; 0 < l; l--)
                        if (!H[l].isDirty) {
                            ...
                            if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) {
                                d = d || l;
                                f = l;
                                for (k = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ba; ) {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++)
                        if (((b = e[d]), f < a)) g++, (f += H[b.id].height + ba), (H[b.id].textBlock.text = ""), (H[b.id].indexLabelText = ""), (H[b.id].isDirty = !0), H[b.id].textBlock.measureText();
                        else break;
                    return g;
                }
                for (var d, e, f, g, k, l, m = 1, q = 0; q < 2 * m; q++) {
                    for (
                        ...
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && k && e + d + ba > +l.y.toFixed(6) && ((d = g.y + d + ba - l.y), (e = a(n, -d)), e < d && (0 < e && (d -= e), (e = a(r(n), d)), e != d)));
                        n--
                    );
                    b();
                }
            ...
            function h(a, b) {
                return (b < S.length ? H[b].textBlock.y : u.reversed ? pa + D : ua + D) - (0 > a ? (u.reversed ? ua - D : pa - D) : H[a].textBlock.y + H[a].height + ba);
            }
            function n(a, b, c) {
                var d,
                    e,
                ...
                if (0 === Y.length) l = ga;
                    ...
                    e = (D * (1 != Y.length || (0 != Y[0] && Y[0] != S.length - 1) ? 2 : 1)) / k();
                    for (var s = 0; s < S.length; s++) {
                        ...
                        l.push(ga[s] + d);
                        if (0 <= Y.indexOf(s) || (s < S.length && 0 <= Y.indexOf(s + 1))) d += e;
                    }
                }
                g = (function () {
            ...
            function k() {
                for (var a = 0, b = 0; b < S.length - 1; b++) (0 <= Y.indexOf(b) || 0 <= Y.indexOf(b + 1)) && a++;
                return a;
            }
            function m(a) {
                for (var b, c, d, e, f = 0; f < S.length; f++)
                    (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
                        ...
                        H[f].isDirty ||
                            0 == H[f].lineThickness ||
                            ((a.strokeStyle = H[f].lineColor), (a.lineWidth = H[f].lineThickness), a.setLineDash && a.setLineDash(I(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke());
            }
            function p(a) {
            ...
            function t(a) {
                for (var b = 0; b < S.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0));
            }
            function v(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, D = 0.025 * x.width, E = 0.01 * x.width, z = 0, C = x.height - 2 * D, F = Math.min(x.width - 2 * E, 2.8 * x.height), M = !1, Q = 0;
                    Q < y.length;
                    Q++
                )
                    if (
                        (!M && "undefined" !== typeof y[Q].indexLabel && null !== y[Q].indexLabel && 0 < y[Q].indexLabel.toString().length && (M = !0),
                        !M && "undefined" !== typeof y[Q].label && null !== y[Q].label && 0 < y[Q].label.toString().length && (M = !0),
                        (!M && "function" === typeof u.indexLabelFormatter) || "function" === typeof y[Q].indexLabelFormatter)
                    )
                        M = !0;
                M = M || ("undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length);
                ("inside" !== u.indexLabelPlacement && M) || (E = (x.width - 0.75 * F) / 2);
                var Q = x.x1 + E,
                    J = x.x2 - E,
                    K = x.y1 + D,
                    R = x.y2 - D,
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
                    ...
                    "funnel" === u.type
                        ? ((O = q(u.options.neckHeight) ? 0.35 * C : u.neckHeight),
                          ...
                          "string" === typeof O && O.match(/%$/) ? ((O = parseInt(O)), (O = (O * C) / 100)) : (O = parseInt(O)),
                          "string" === typeof G && G.match(/%$/) ? ((G = parseInt(G)), (G = (G * a) / 100)) : (G = parseInt(G)),
                          O > C ? (O = C) : 0 >= O && (O = 0),
                          G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
                        : "pyramid" === u.type && ((G = O = 0), (u.reversed = u.reversed ? !1 : !0));
                    var E = Q + a / 2,
                        U = Q,
                        X = Q + a,
                        pa = u.reversed ? R : K,
                    ...
                    var E = [],
                        ...
                        aa = (Ca - pa) / (L - U),
                        fa = -aa,
                        Q = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== Q) {
                        if (u.reversed) for (F.push(V), G = Q.length - 1; 0 < G; G--) (V += Q[G]), F.push(V);
                        else for (G = 0; G < Q.length; G++) (V += Q[G]), F.push(V);
                        if (u.reversed) for (G = 0; G < Q.length; G++) F[G] < Ca ? (a.push(L), E.push(Z), (ca = G)) : (a.push((F[G] - pa + aa * U) / aa), E.push((F[G] - pa + fa * X) / fa));
                        else for (G = 0; G < Q.length; G++) F[G] < Ca ? (a.push((F[G] - pa + aa * U) / aa), E.push((F[G] - pa + fa * X) / fa), (ca = G)) : (a.push(L), E.push(Z));
                        for (G = 0; G < Q.length - 1; G++)
                            (V = u.reversed ? (y[y.length - 1 - G].color ? y[y.length - 1 - G].color : u._colorSet[(y.length - 1 - G) % u._colorSet.length]) : y[G].color ? y[G].color : u._colorSet[G % u._colorSet.length]),
                                G === ca
                                    ? S.push({ x1: a[G], y1: F[G], x2: E[G], y2: F[G], x3: Z, y3: Ca, x4: E[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: L, y6: Ca, id: G, height: F[G + 1] - F[G], color: V })
                                    : S.push({ x1: a[G], y1: F[G], x2: E[G], y2: F[G], x3: E[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: V });
                        var ba = 2,
                            H = [],
                            ha = !1,
                            Y = [],
                        ...
                        a = a = 0;
                        Ea(Y);
                        for (G = 0; G < y.length; G++) y[G].exploded && ((Q = !0), u.reversed ? Y.push(y.length - 1 - G) : Y.push(G));
                        ...
                        if (M && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            ...
                            for (G = 0; G < S.length; G++) (S[G].x1 += z), (S[G].x2 += z), (S[G].x3 += z), (S[G].x4 += z), S[G].x5 && ((S[G].x5 += z), (S[G].x6 += z)), (H[G].textBlock.x += z);
                        }
                        for (G = 0; G < S.length; G++) (z = S[G]), ta(P, z, u.fillOpacity), ga.push(z.y1);
                        v(P);
                        M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || m(P), A.animationEnabled || t());
                        if (!M)
                            for (G = 0; G < y.length; G++)
                                (z = u.dataPointIds[G]), (a = { id: z, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: S[u.reversed ? y.length - 1 - G : G] }), (A._eventManager.objectMap[z] = a);
                        !A.animationEnabled && Q ? n(A, -1, 0) : A.animationEnabled && !A.animatedRender && n(A, -1, 0);
                        this.funnelPyramidClickHandler = function (a) {
                            var b = -1;
                            if (!ha && !A.isAnimating && (q(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && ((b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex), 0 <= b)) {
                                a = b;
        ...
        n.prototype.exportChart = function (a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob()) {
                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), q = 0; q < l.length; q++) h[q] = l.charCodeAt(q);
        ...
        n.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do {
                    ...
                    a = a.replace("#total", Y(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo));
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                if ("x" === a)
                    ...
                    } else return Y(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : (c.xValueFormatString = "#,##0.########"), f._cultureInfo);
                else
                    return "y" === a
                        ? Y(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : (c.yValueFormatString = "#,##0.########"), f._cultureInfo)
                        : "z" === a
                        ? Y(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : (c.zValueFormatString = "#,##0.########"), f._cultureInfo)
                        : g;
            });
        };
        qa(P, V);
        P.prototype.setLayout = function () {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                f = 0,
                l = 0,
                h = (this.markerMargin = this.chart.options.legend && !q(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize);
            this.height = 0;
            var n = [],
                k = [];
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var r = (p.legendMarkerType = p.legendMarkerType
                            ...
                            t = (p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? (q(p.whiskerColor) ? p._colorSet[0] : p.whiskerColor) : p._colorSet[0]),
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x = p.dataPoints[y],
                                r = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : W.getDefaultLegendMarker(p.type),
                                g = x.legendText
                                    ? x.legendText
                                    : p.legendText
                                    ? p.legendText
                                    : this.itemTextFormatter
                                    ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: x })
                                    : x.name
                                    ? x.name
                                    : "DataPoint: " + (y + 1),
                                ...
                                r = { markerType: r, markerColor: t, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: m, dataPointIndex: y, markerBorderColor: v, markerBorderThickness: u };
                            (x.showInLegend || (p.showInLegend && !1 !== x.showInLegend)) && n.push(r);
                        }
            }
            ...
            if (0 < n.length) {
                ...
                for (m = 0; m < n.length; m++) {
                    r = n[m];
                    v = x;
                    if ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType) v -= 2 * 0.1 * this.lineHeight;
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            null !== this.itemWidth && (r.textBlock.width = this.itemWidth - (w + h + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                            if (
                                !p ||
                                p.width +
                                    Math.round(r.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                                    f
                            )
                            ...
                            (r.textBlock = new ja(this.ctx, {
                                ...
                                r.textBlock.measureText(),
                                null !== this.itemWidth && (r.textBlock.width = this.itemWidth - (w + h + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                                this.height < l - this.lineHeight ? ((p = { items: [], width: 0 }), k.push(p)) : ((p = k[y]), (y = (y + 1) % k.length)),
                                (this.height += r.textBlock.height);
                        r.textBlock.x = p.width;
                        r.textBlock.y = 0;
                        p.width += Math.round(r.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0));
                        p.items.push(r);
                        this.width = Math.max(p.width, this.width);
                        t = r.textBlock.width + (w + h + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0));
                    }
                }
                this.itemWidth = t;
            ...
            for (m = 0; m < this.items.length; m++)
                (r = n[m]),
                    ...
                    (this.chart._eventManager.objectMap[r.id] = { id: r.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: r.dataSeriesIndex, dataPointIndex: r.dataPointIndex });
            this.markerSize = w;
            this.rows = k;
        ...
        P.prototype.render = function () {
            ...
            for (var h = 0, q = 0; q < l.length; q++) {
                for (var k = l[q], m = 0, p = 0; p < k.items.length; p++) {
                    var r = k.items[p],
                        g = r.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing),
                        n = d + h,
                        w = g;
                    ...
                    if ("line" === r.chartType || "stepLine" === r.chartType || "spline" === r.chartType)
                        (this.ctx.strokeStyle = r.lineColor),
                            ...
                            this.ctx.beginPath(),
                            this.ctx.moveTo(g - 0.1 * this.lineHeight, n + this.lineHeight / 2),
                            this.ctx.lineTo(g + 0.85 * this.lineHeight, n + this.lineHeight / 2),
                            this.ctx.stroke(),
                    ...
                    this.ghostCtx.fillRect(w, r.textBlock.y - this.lineHeight / 2, r.textBlock.x + r.textBlock.width - w, r.textBlock.height);
                    ...
                    r.y2 = this.chart._eventManager.objectMap[r.id].y2 = r.textBlock.y + r.textBlock.height - this.lineHeight / 2;
                }
                h += m;
            }
        };
        ...
        W.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (((p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d })), this.axisX.logarithmic))
                    var r = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                        ...
                        switch (this.type) {
                            ...
                            case "error":
                                a >= r.x1 &&
                                    ...
                                    d >= r.y1 &&
                                    d <= r.y2 &&
                                    (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y1 - d), Math.abs(r.y2 - d)) }), (h = !0));
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "scatter":
                                ...
                                n <= v && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: n });
                                r = Math.abs(r.x1 - a);
                                r <= q ? (q = r) : 0 < l ? k++ : m++;
                                n <= w / 2 && (h = !0);
                                break;
                            ...
                            case "rangeSplineArea":
                                ...
                                v = c ? 20 : w;
                                n = Math.min(Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y1 - d, 2)), Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y2 - d, 2)));
                                n <= v && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: n });
                                r = Math.abs(r.x1 - a);
                                r <= q ? (q = r) : 0 < l ? k++ : m++;
                                n <= w / 2 && (h = !0);
                            ...
                            case "bubble":
                                w = r.size;
                                n = Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y1 - d, 2));
                                n <= w / 2 && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: n }), (h = !0));
                                break;
                            case "pie":
                            case "doughnut":
                                w = r.center;
                                v = "doughnut" === this.type ? r.percentInnerRadius * r.radius : 0;
                                n = Math.sqrt(Math.pow(w.x - a, 2) + Math.pow(w.y - d, 2));
                                n < r.radius &&
                                    n > v &&
                                    ((n = Math.atan2(d - w.y, a - w.x)),
                                    0 > n && (n += 2 * Math.PI),
                                    (n = Number(((((180 * (n / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                                    (w = Number(((((180 * (r.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                                    (v = Number(((((180 * (r.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                                    0 === v && 1 < r.endAngle && (v = 360),
                                    w >= v && 0 !== g.y && ((v += 360), n < w && (n += 360)),
                                    n > w && n < v && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                n = r.funnelSection;
                                d > n.y1 &&
                                    ...
                                    (n.y6
                                        ? d > n.y6
                                            ? ((f = n.x6 + ((n.x5 - n.x6) / (n.y5 - n.y6)) * (d - n.y6)), (n = n.x3 + ((n.x4 - n.x3) / (n.y4 - n.y3)) * (d - n.y3)))
                                            : ((f = n.x1 + ((n.x6 - n.x1) / (n.y6 - n.y1)) * (d - n.y1)), (n = n.x2 + ((n.x3 - n.x2) / (n.y3 - n.y2)) * (d - n.y2)))
                                        : ((f = n.x1 + ((n.x4 - n.x1) / (n.y4 - n.y1)) * (d - n.y1)), (n = n.x2 + ((n.x3 - n.x2) / (n.y3 - n.y2)) * (d - n.y2))),
                                    a > f && a < n && (b.push({ dataPoint: g, dataPointIndex: r.dataPointIndex, dataSeries: this, distance: 0 }), (h = !0)));
                                break;
                            case "boxAndWhisker":
                                if (
                                    (a >= r.x1 - r.borderThickness / 2 && a <= r.x2 + r.borderThickness / 2 && d >= r.y4 - r.borderThickness / 2 && d <= r.y1 + r.borderThickness / 2) ||
                                    (Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y1 && d <= r.y4)
                                )
                                    b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y2 - d), Math.abs(r.y3 - d)) }), (h = !0);
                                break;
                            case "candlestick":
                                if (
                                    (a >= r.x1 - r.borderThickness / 2 && a <= r.x2 + r.borderThickness / 2 && d >= r.y2 - r.borderThickness / 2 && d <= r.y3 + r.borderThickness / 2) ||
                                    (Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y1 && d <= r.y4)
                                )
                                    b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y2 - d), Math.abs(r.y3 - d)) }), (h = !0);
                                break;
                            case "ohlc":
                                if (
                                    (Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y2 && d <= r.y3) ||
                                    (a >= r.x1 && a <= (r.x2 + r.x1) / 2 && d >= r.y1 - r.borderThickness / 2 && d <= r.y1 + r.borderThickness / 2) ||
                                    (a >= (r.x1 + r.x2) / 2 && a <= r.x2 && d >= r.y4 - r.borderThickness / 2 && d <= r.y4 + r.borderThickness / 2)
                                )
                                    b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y2 - d), Math.abs(r.y3 - d)) }), (h = !0);
                        }
        ...
        A.prototype.createLabels = function () {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || ((this.logLabelValues = []), this.createExtraLabelsForLog()), b = 0, g = r; b < this.logLabelValues.length; b++)
                ...
                (h =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ? (this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
                          Math.log(this.range)
                        : (this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * K[this.intervalType + "Duration"] * this.interval),
                ...
                (h =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ? (this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
                          Math.log(this.range)
                        : (this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * K[this.intervalType + "Duration"] * this.interval),
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (
                    ...
                    if (((f = (0.9 * h) >> 0), (r = 0), !this.chart.panEnabled && 1 <= this._labels.length)) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, g = a.text.split(" "), b = 0; b < g.length; b++)
                                    (m = g[b]), (this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily), (m = this.ctx.measureText(m)), m.width > r && ((v = c), (r = m.width));
                            }
                        c = 0;
                                ...
                                if (q(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ...
                                        this.labelWrap
                                            ? q(this.options.labelMaxWidth)
                                                ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, r), m)),
                                                  (this.sessionVariables.labelWrap = this.labelWrap),
                                                  d && (t.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                                : ((this.sessionVariables.labelWrap = this.labelWrap),
                                            ...
                                            ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelMaxWidth = f),
                                              d && (t.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = m)))
                                            : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelWrap = this.labelWrap));
                                        ...
                                        if (q(this.options.labelWrap))
                                            if (!q(this.options.labelMaxWidth))
                                                ...
                                                if (((b = (t.width + d.width) >> 0), (g = this.labelFontSize), r < f))
                                                    b - 2 * f > p &&
                                                        ((p = b - 2 * f),
                                                        b >= 2 * f && b < 2.2 * f
                                                            ? ((this.sessionVariables.labelMaxWidth = f),
                                                              q(this.options.labelFontSize) && 12 < g && ((g = Math.floor((12 / 13) * g)), a.measureText()),
                                                              (this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                                              (this.sessionVariables.labelAngle = this.labelAngle))
                                                            : b >= 2.2 * f && b < 2.8 * f
                                                            ? ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = m), (this.sessionVariables.labelFontSize = g))
                                                            : b >= 2.8 * f && b < 3.2 * f
                                                            ? ((this.sessionVariables.labelMaxWidth = Math.max(f, r)),
                                                              (this.sessionVariables.labelWrap = !0),
                                                              q(this.options.labelFontSize) && 12 < this.labelFontSize && ((this.labelFontSize = Math.floor((12 / 13) * this.labelFontSize)), a.measureText()),
                                                              (this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                                              (this.sessionVariables.labelAngle = this.labelAngle))
                                                            : b >= 3.2 * f && b < 3.6 * f
                                                    ...
                                                    v === c &&
                                                    ((0 === v && r + this._labels[v + 1].textBlock.measureText().width - 2 * f > p) ||
                                                        (v === this._labels.length - 1 && r + this._labels[v - 1].textBlock.measureText().width - 2 * f > p) ||
                                                        (0 < v && v < this._labels.length - 1 && r + this._labels[v + 1].textBlock.measureText().width - 2 * f > p && r + this._labels[v - 1].textBlock.measureText().width - 2 * f > p))
                                                )
                                                    (p = 0 === v ? r + this._labels[v + 1].textBlock.measureText().width - 2 * f : r + this._labels[v - 1].textBlock.measureText().width - 2 * f),
                                                        (this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                                        (this.sessionVariables.labelWrap = !0),
                                                        (this.sessionVariables.labelAngle = -25),
                                                        (this.sessionVariables.labelMaxWidth = m);
                                                else if (0 === p)
                                                    for (this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++)
                                                        (a = this._labels[b].textBlock),
                                                            (a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, r), m)),
                                                            (t = a.measureText()),
                                                            b < this._labels.length - 1 &&
                                                                ((g = b + 1),
                                                                (d = this._labels[g].textBlock),
                                                                (d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, r), m)),
                                                                (d = d.measureText()),
                                                                (t.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25));
                                    }
                                else
                                    ((this.sessionVariables.labelAngle = this.labelAngle),
                                    ...
                                    q(this.options.labelWrap))
                                        ...
                                        : (this.options.labelWrap
                                              ...
                                              : (q(this.options.labelMaxWidth), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m), (this.sessionVariables.labelWrap = this.labelWrap)),
                                          (this.sessionVariables.labelMaxHeight = l));
                            }
                        for (b = 0; b < this._labels.length; b++)
                            (a = this._labels[b].textBlock),
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            (a = this._labels[c].textBlock),
                                (a.maxWidth = this.labelMaxWidth = q(this.options.labelMaxWidth)
                                ...
                                (a.angle = this.labelAngle = q(this.options.labelAngle) ? (q(this.sessionVariables.labelAngle) ? (this.sessionVariables.labelAngle = this.labelAngle) : this.sessionVariables.labelAngle) : this.labelAngle),
                                (a.wrap = this.labelWrap = q(this.options.labelWrap) ? (q(this.sessionVariables.labelWrap) ? (this.sessionVariables.labelWrap = this.labelWrap) : this.sessionVariables.labelWrap) : this.options.labelWrap),
                                (a.maxHeight = q(this.sessionVariables.labelMaxHeight) ? (this.sessionVariables.labelMaxHeight = l) : this.sessionVariables.labelMaxHeight),
                                a.measureText();
                else if ("left" === this._position || "right" === this._position)
                    if (
                        ((f = q(this.options.labelMaxWidth) ? (0.3 * this.chart.width) >> 0 : this.options.labelMaxWidth),
                        (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? (0.3 * this.chart.height) >> 0 : 1.5 * this.labelFontSize),
                        ...
                        this.sessionVariables.labelMaxWidth = f;
                        this.sessionVariables.labelMaxHeight = l;
                        this.sessionVariables.labelAngle = q(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle;
                        this.sessionVariables.labelWrap = this.labelWrap;
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                a = this._labels[c].textBlock;
                                ...
                                Math.cos((Math.PI / 180) * Math.abs(this.labelAngle));
                                Math.sin((Math.PI / 180) * Math.abs(this.labelAngle));
                                q(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                                    ? q(this.options.labelWrap)
                                        ? q(this.options.labelWrap) &&
                                          (q(this.options.labelMaxWidth)
                                              ? q(d) ||
                                                ...
                                                h - 2 * l > r &&
                                                    ...
                                                    h >= 2 * l && h < 2.4 * l
                                                        ? (q(this.options.labelFontSize) && 12 < this.labelFontSize && ((this.labelFontSize = Math.floor((12 / 13) * this.labelFontSize)), a.measureText()),
                                                          (this.sessionVariables.labelMaxHeight = l),
                                                          (this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize))
                                                        : h >= 2.4 * l && h < 2.8 * l
                                    ...
                                    ? q(this.options.labelWrap) &&
                                      (this.labelWrap && !q(this.options.labelMaxWidth)
                                          ...
                                          : ((this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f),
                                            ...
                                            q(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle)))
                                    : this.options.labelWrap
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        q(f.options.labelWrap) && !q(this.sessionVariables.stripLineLabelMaxHeight)
                            ? (A = this.sessionVariables.stripLineLabelMaxHeight)
                            : (this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? (0.8 * this.chart.height) >> 0 : 1.5 * this.labelFontSize);
                    ...
                    (l = "bottom" === this._position || "top" === this._position ? (0.9 * this.chart.width) >> 0 : (0.9 * this.chart.height) >> 0),
                        (A = q(f.options.labelWrap) || f.labelWrap ? ("bottom" === this._position || "top" === this._position ? (0.8 * this.chart.width) >> 0 : (0.8 * this.chart.height) >> 0) : 1.5 * this.labelFontSize),
                        q(f.labelBackgroundColor) && (q(f.startValue) && 0 !== f.startValue ? (f.labelBackgroundColor = w ? "transparent" : null) : (f.labelBackgroundColor = "#EEEEEE"));
                a = new ja(this.ctx, {
                    x: 0,
                    y: 0,
        ...
        A.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < r.length; g++)
                if (r[g] && r[g].scaleBreaks && r[g].scaleBreaks._appliedBreaks.length)
                    for (var t = r[g].scaleBreaks._appliedBreaks, w = 0; w < t.length && !(t[w].startValue > r[g].viewportMaximum); w++)
                        t[w].endValue < r[g].viewportMinimum || (q(r[g].scaleBreaks.firstBreakIndex) && (r[g].scaleBreaks.firstBreakIndex = w), t[w].startValue >= r[g].viewPortMinimum && (r[g].scaleBreaks.lastBreakIndex = w));
            for (var v = (w = 0), u = 0, y = 0, x = 0, A = 0, E = 0, z, C, F = (h = 0), I, Q, J, t = (I = Q = J = !1), g = 0; g < r.length; g++)
                r[g] &&
                    r[g].title &&
                ...
                if (r[g].title)
                    switch (r[g]._position) {
                        case "left":
                            ...
                            r[g]._titleTextBlock.maxHeight = r[g].titleWrap ? 0.8 * f.width : 1.5 * r[g].titleFontSize;
                        ...
                        case "right":
                            ...
                            break;
                        default:
                            (r[g]._titleTextBlock.maxWidth = r[g].titleMaxWidth || f.width), (r[g]._titleTextBlock.maxHeight = r[g].titleWrap ? 0.8 * f.height : 1.5 * r[g].titleFontSize), (r[g]._titleTextBlock.angle = 0);
                    }
            if ("normal" === e) {
                for (var y = [], x = [], A = [], E = [], K = [], N = [], O = [], P = []; 4 > w; ) {
                    var G = 0,
                        R = 0,
                        T = 0,
                        W = 0,
                        ...
                        S = 0,
                        Z = 0;
                    if (c && 0 < c.length) for (A = [], g = S = 0; g < c.length; g++) A.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (S += A[g]), (L += c[g] && !m.isNavigator ? c[g].margin : 0);
                    else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    O.push(A);
                    if (b && 0 < b.length) for (E = [], g = Z = 0; g < b.length; g++) E.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), (Z += E[g]), (Y += b[g] ? b[g].margin : 0);
                    else E.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    P.push(E);
                    l = Math.round(f.x1 + S + L);
                    n = Math.round(f.x2 - Z - Y > m.width - p ? m.width - p : f.x2 - Z - Y);
                    if (a && 0 < a.length)
                    ...
                    if (d && 0 < d.length)
                        for (x = [], g = X = 0; g < d.length; g++)
                            d[g] && (d[g].lineCoordinates = {}),
                                ...
                                x.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)),
                                (X += x[g]),
                        ...
                        for (g = 0; g < a.length; g++)
                            a[g] &&
                                ...
                                !a[g] ||
                                    ...
                                    ((h = 0),
                                    0 < a[g].labelAngle
                                        ? C + u > n && (h += 0 < a[g].labelAngle ? C + u - n - Z : 0)
                                        : 0 > a[g].labelAngle
                                        ? z - v < l && z - v < a[g].viewportMinimum && (F = l - (L + a[g].tickLength + A + z - v + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (C + u > n && (h = C + u / 2 - n - Z), z - v < l && z - v < a[g].viewportMinimum && (F = l - L - a[g].tickLength - A - z + v / 2)),
                                ...
                                m.panEnabled ? (V = q(m.sessionVariables.axisX.height) ? (m.sessionVariables.axisX.height = V) : m.sessionVariables.axisX.height) : (m.sessionVariables.axisX.height = V),
                                ...
                                "inside" === a[g].labelPlacement &&
                                    0 < g &&
                                    ((a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + y[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0)),
                                    (a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2)),
                                (a[g].bounds = { x1: l, y1: h, x2: n, y2: k - (V + e - y[g] - G), width: n - l, height: k - h })),
                                (G += y[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + S + L)),
                                (d[g].lineCoordinates.x2 = Math.round(f.x2 - Z - Y > m.width - p ? m.width - p : f.x2 - Z - Y)),
                                (d[g].lineCoordinates.width = Math.abs(n - l)),
                                d[g]._labels &&
                                    ...
                                    (v = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                                    (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                                m.panEnabled ? (X = q(m.sessionVariables.axisX2.height) ? (m.sessionVariables.axisX2.height = X) : m.sessionVariables.axisX2.height) : (m.sessionVariables.axisX2.height = X),
                                (h = Math.round(f.y1)),
                                (k = Math.round(f.y2 + d[g].margin)),
                                (d[g].lineCoordinates.y1 = h + X + U - R),
                                (d[g].lineCoordinates.y2 = h),
                                "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - x[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)),
                                (d[g].bounds = { x1: l, y1: h + (X + U - x[g] - R), x2: n, y2: k, width: n - l, height: k - h }),
                                (R += x[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (L = m.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (h = Math.round(f.y1 + X + U < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + U)),
                                    ...
                                    (c[g].lineCoordinates = { x1: l - T, y1: h, x2: n - T, y2: k, height: Math.abs(k - h) }),
                                    ...
                                    (c[g].bounds = { x1: l - (A[g] + T), y1: h, x2: n, y2: k, width: n - l, height: k - h }),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (k = Math.round(f.y2 - (V + e + L))),
                                (b[g].lineCoordinates = { x1: l + W, y1: h, x2: l + W, y2: k, height: Math.abs(k - h) }),
                                "inside" === b[g].labelPlacement &&
                                    0 < g &&
                                    ((b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (E[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
                                    (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                                (b[g].bounds = { x1: l, y1: h, x2: n + (E[g] + W), y2: k, width: n - l, height: k - h }),
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = K[w - 1][g] === K[w][g] ? !0 : !1;
                        else t = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) Q = O[w - 1][g] === O[w][g] ? !0 : !1;
                        else Q = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) J = P[w - 1][g] === P[w][g] ? !0 : !1;
                        else J = !0;
                    }
                    if (t && I && Q && J) break;
                    w++;
                ...
                for (N = []; 4 > w; ) {
                    ...
                    if (a && 0 < a.length) for (F = [], g = W = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (W += F[g]), (e += a[g] && !m.isNavigator ? a[g].margin : 0);
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    K.push(F);
                    if (d && 0 < d.length) for (v = [], g = V = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (V += v[g]), (U += d[g] ? d[g].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                ...
                                (n = Math.round(f.x2 - V - U > m.width - 10 ? m.width - 10 : f.x2 - V - U)),
                                c[g].labelAutoFit &&
                                    !q(y) &&
                                    (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l),
                                    0 < !d.length && (n = 0 < c[g].labelAngle ? n - x / 2 : 0 === c[g].labelAngle ? n - x / 2 : n)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                (l = Math.round(f.x1 + W + e)),
                                (n = Math.round(f.x2 - V - U > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - U)),
                                b[g] && b[g].labelAutoFit && !q(A) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, A) : 0 === b[g].labelAngle ? Math.max(l, A / 2) : l), 0 < !d.length && (n -= E / 2)),
                    ...
                    if (c && 0 < c.length) for (p = [], g = T = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (T += p[g] + c[g].margin), (L += c[g].margin);
                    else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    C.push(p);
                    if (b && 0 < b.length) for (z = [], g = R = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (R += z[g]), (Y += b[g].margin);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length &&
                                ...
                                (x = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (E = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))));
                    if (m.panEnabled) for (g = 0; g < c.length; g++) p[g] = q(m.sessionVariables.axisY.height) ? (m.sessionVariables.axisY.height = p[g]) : m.sessionVariables.axisY.height;
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (h = Math.round(f.y2)),
                                ...
                                (c[g].bounds = { x1: l, y1: h - (p[g] + X + c[g].margin), x2: n, y2: k - (X + c[g].margin), width: n - l, height: p[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (X += p[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ...
                                (b[g].bounds = { x1: l, y1: h + (b[g].margin + G), x2: n, y2: k, width: n - l, height: R }),
                                b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                                (G += z[g] + b[g].margin));
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - T)
                                    : f.y2 > m.height - Math.max(L, 10)
                                    ? m.height - Math.max(L, 10)
                                    : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - W : l));
                            if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x1), (l = n - W));
                            ...
                            a[g].bounds = { x1: n - (F[g] + O), y1: h, x2: n, y2: k, width: n - l, height: k - h };
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - V : l));
                            if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x2), (l = n - V));
                            d[g].lineCoordinates = { x1: n + P, y1: h, x2: n + P, y2: k, height: Math.abs(k - h) };
                            ...
                            d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: h, x2: n + v[g] + P, y2: k, width: n - l, height: k - h };
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) Q = C[w - 1][g] === C[w][g] ? !0 : !1;
                        else Q = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) J = u[w - 1][g] === u[w][g] ? !0 : !1;
                        else J = !0;
                    }
                    if (t && I && Q && J) break;
                    w++;
            ...
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
                    a[d].endValue < this.conversionParameters.minimum ||
                        (q(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d),
                    ...
                    (p = this._labels[k]),
                        p.position < this.viewportMinimum ||
                            ...
                            this.tickThickness &&
                                ...
                                (b = 1 === this.ctx.lineWidth % 2 ? (r.x << 0) + 0.5 : r.x << 0),
                                this.ctx.beginPath(),
                                    ...
                                    ? ((r.x -= p.textBlock.width / 2),
                                      (r.y =
                                          "inside" === this.labelPlacement
                                              ? r.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + p.textBlock.height - p.textBlock.fontSize / 2)
                                              : r.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + p.textBlock.fontSize / 2 + 5))
                                    : ((r.x =
                                          "inside" === this.labelPlacement
                                              ? 0 > this.labelAngle
                                                  ? r.x
                                                  : r.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                                              : r.x - (0 > this.labelAngle ? p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                                      (r.y =
                                          "inside" === this.labelPlacement
                                              ? 0 > this.labelAngle
                                                  ? r.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5
                                                  : r.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - Math.abs(p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5)
                                              : r.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5 : 5))),
                                (p.textBlock.x = r.x),
                                (p.textBlock.y = r.y)));
                "inside" === this.tickPlacement &&
                            ...
                            (d && 0 !== f++ % 2 && this.labelAutoFit) ||
                                (0 === p.textBlock.angle
                                    ? ((r.x -= p.textBlock.width / 2),
                                      (r.y =
                                          "inside" === this.labelPlacement
                                              ? r.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                              : r.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + p.textBlock.height - p.textBlock.fontSize / 2)))
                                    : ((r.x =
                                          "inside" === this.labelPlacement
                                              ? 0 < this.labelAngle
                                                  ? r.x
                                                  : r.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                                              : r.x + (p.textBlock.height - this.labelFontSize) * Math.sin((Math.PI / 180) * this.labelAngle) - (0 < this.labelAngle ? p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                                      (r.y =
                                          "inside" === this.labelPlacement
                                              ? 0 < this.labelAngle
                                                  ? r.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                                  : r.y - p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                              : r.y -
                    ...
                    (p = this._labels[k]),
                        p.position < this.viewportMinimum ||
                            ...
                            this.tickThickness &&
                                ...
                                ((this.ctx.lineWidth = this.tickThickness),
                                (this.ctx.strokeStyle = this.tickColor),
                                (b = 1 === this.ctx.lineWidth % 2 ? (r.y << 0) + 0.5 : r.y << 0),
                                this.ctx.beginPath(),
                            ...
                            (d && 0 !== f++ % 2 && this.labelAutoFit) ||
                                (0 === this.labelAngle
                                    ? ((p.textBlock.y = r.y),
                                      (p.textBlock.x =
                                          "inside" === this.labelPlacement
                                              ? r.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                              : r.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5))
                                    : ((p.textBlock.y = "inside" === this.labelPlacement ? r.y : r.y - p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                                      (p.textBlock.x =
                                          "inside" === this.labelPlacement
                                              ? r.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                              : 0 < this.labelAngle
                        ...
                        p.position < this.viewportMinimum ||
                            ...
                            (d && 0 !== f++ % 2 && this.labelAutoFit) ||
                                (0 === this.labelAngle
                                    ? ((p.textBlock.y = r.y),
                                      (p.textBlock.x =
                                          "inside" === this.labelPlacement ? r.x - p.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : r.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5))
                                    : ((p.textBlock.y =
                                          "inside" === this.labelPlacement
                                              ? r.y - p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)
                                              : 0 > this.labelAngle
                                              ? r.y
                                              : r.y - (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.cos((Math.PI / 180) * this.labelAngle)),
                                      (p.textBlock.x =
                                          "inside" === this.labelPlacement
                                              ? r.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5
                                              : 0 < this.labelAngle
                                              ? r.x + (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) + ("inside" === this.tickPlacement ? 0 : this.tickLength)
                                              : r.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5))));
                "inside" === this.tickPlacement &&
                    this.chart.addEventListener(
                        "dataAnimationEnd",
                        function () {
        ...
        A.prototype.renderStripLinesOfThicknessType = function (a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], n = [], l = !1, b = 0; b < this.stripLines.length; b++) {
                    ...
                    k._thicknessType === a &&
                        (("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || q(k.value) || isNaN(this.range))) ||
                            ("value" === a &&
                                ...
                                "bottom" === this._position
                                    ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.height - 3),
                                      ...
                                      a.x - c.textBlock.height > this.chart.plotArea.x1
                                          ...
                                          : ((c.textBlock.angle = 90), q(k.startValue) ? (a.x += c.textBlock.height - c.textBlock.fontSize / 2) : (a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3)),
                                      (a.y =
        ...
        A.prototype.createMask = function () {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                w ? ((this.maskCanvas = va(this.chart.width, this.chart.height)), (this.maskCtx = this.maskCanvas.getContext("2d"))) : ((this.maskCanvas = this.chart.plotArea.canvas), (this.maskCtx = this.chart.plotArea.ctx));
                this.maskCtx.save();
        ...
        A.prototype.getApparentDifference = function (a, d, c, b) {
            ...
            if (this.logarithmic) {
                ...
                for (c = q(c) ? Math.abs(d - a) : c, f = 0; f < e.length && !(d < e[f].startValue); f++)
                    a > e[f].endValue ||
                        (a <= e[f].startValue && d >= e[f].endValue
                            ? (c = c - e[f].endValue + e[f].startValue + e[f].size)
                            : a > e[f].startValue && d >= e[f].endValue
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if (this.scaleBreaks)
                    for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)
                        if (
                            ((!q(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue) ||
                                (!q(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[b].startValue) ||
                                (!q(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue)) &&
                            ((!q(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue) ||
                                (!q(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[b].endValue) ||
                                (!q(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue))
                        ) {
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType ||
                        (b / 1 <= a
                            ...
                            : ((this.interval = b / (1 * K.yearDuration) <= a ? 1 : b / (2 * K.yearDuration) <= a ? 2 : b / (4 * K.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b / (a - 1), !0) / K.yearDuration)),
        ...
        A.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            if (this.scaleBreaks)
                for (l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
                    if (
                        ((!q(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) ||
                            (!q(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue) ||
                            (!q(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue)) &&
                        ((!q(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue) ||
                            (!q(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue) ||
                            (!q(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue))
                    ) {
            ...
            if (0 !== this.spacing || (0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness))) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (
                        ...
                        f = 0.5;
                        m = (n - k) / a / 3;
                        for (var r = 0; r < m; r++) this.ctx.bezierCurveTo(q + f * a, k + a, q + f * a, k + 2 * a, q, k + 3 * a), (k += 3 * a), (f *= -1);
                        this.ctx.bezierCurveTo(q + f * a, k + a, q + f * a, k + 2 * a, q, k + 3 * a);
                        q = h;
                        f *= -1;
                        this.ctx.lineTo(q, k);
                        for (r = 0; r < m; r++) this.ctx.bezierCurveTo(q + f * a, k - a, q + f * a, k - 2 * a, q, k - 3 * a), (k -= 3 * a), (f *= -1);
                    } else {
                        if ("zigzag" === this.type) {
                            f = -1;
                            k = e + a;
                            q = b + a;
                            m = (n - k) / a / 2;
                            for (r = 0; r < m; r++) this.ctx.lineTo(q, k), (q += 2 * f * a), (k += 2 * a), (f *= -1);
                            this.ctx.lineTo(q, k);
                            q += h - b;
                            for (r = 0; r < m + 1; r++) this.ctx.lineTo(q, k), (q += 2 * f * a), (k -= 2 * a), (f *= -1);
                    ...
                    if (
                        ...
                        f = 0.5;
                        m = (h - q) / a / 3;
                        for (r = 0; r < m; r++) this.ctx.bezierCurveTo(q + a, k + f * a, q + 2 * a, k + f * a, q + 3 * a, k), (q += 3 * a), (f *= -1);
                        this.ctx.bezierCurveTo(q + a, k + f * a, q + 2 * a, k + f * a, q + 3 * a, k);
                        k = n;
                        f *= -1;
                        this.ctx.lineTo(q, k);
                        for (r = 0; r < m; r++) this.ctx.bezierCurveTo(q - a, k + f * a, q - 2 * a, k + f * a, q - 3 * a, k), (q -= 3 * a), (f *= -1);
                        ...
                        q = b + a;
                        m = (h - q) / a / 2;
                        for (r = 0; r < m; r++) this.ctx.lineTo(q, k), (k += 2 * f * a), (q += 2 * a), (f *= -1);
                        this.ctx.lineTo(q, k);
                        k += n - e;
                        for (r = 0; r < m + 1; r++) this.ctx.lineTo(q, k), (k += 2 * f * a), (q -= 2 * a), (f *= -1);
        ...
        aa.prototype.render = function (a, d, c) {
            ...
            this.labelMaxWidth = q(this.options.labelMaxWidth) ? 0.3 * this.chart.width : this.labelMaxWidth;
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) t = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
                    else if ("left" === this.parent._position || "right" === this.parent._position) t = this.parent.convertPixelToValue({ y: d });
                    for (var C = 0; C < this.parent.dataSeries.length; C++)
                        (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[C]), null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[C].dataPoint.y[0])), u = 0, t = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (var y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else (u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y))), u < v && ((v = u), (C = t));
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = (u = 0), t = (C = 0); t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else (x += m[t].dataPoint.y), (u = Math.abs(a - this.parent.convertValueToPixel(x))), u < v && ((v = u), (C = t));
                    else if ("stackedBar100" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), D = (x = u = 0), t = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else
                                (x += m[t].dataPoint.y),
                                    (D = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x),
                                    (D = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[D])),
                                    (u = Math.abs(a - this.parent.convertValueToPixel(D))),
                                    u < v && ((v = u), (C = t));
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = C = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else (u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y))), u < v && ((v = u), (C = t));
                    y = m[C];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        b = 0;
                        if ("rangeBar" === this.parent.dataSeries[C].type || "error" === this.parent.dataSeries[C].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[0]));
                            for (t = u = 0; t < y.dataPoint.y.length; t++) (u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[t]))), u < v && ((v = u), (b = t));
                            n = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0;
                            this.value = y.dataPoint.y[b];
                            k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b] })
                                : q(this.options.label)
                                ? Y(q(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                        } else if ("stackedBar" === this.parent.dataSeries[C].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            x = u = 0;
                            for (t = C; 0 <= t; t--) (x += m[t].dataPoint.y), (u = Math.abs(a - this.parent.convertValueToPixel(x))), u < v && ((v = u), (b = t));
                            n = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0;
                            this.value = x;
                            k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y })
                                : q(this.options.label)
                                ? Y(q(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            for (t = C; 0 <= t; t--)
                                (x += m[t].dataPoint.y),
                                    ...
                                    (u = Math.abs(a - this.parent.convertValueToPixel(D))),
                                    u < v && ((v = u), (b = t));
                            n = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(D) << 0) + 0.5 : this.parent.convertValueToPixel(D) << 0;
                            this.value = D;
                            k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: D })
                                : q(this.options.label)
                                ? Y(q(c) ? D : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                        } else
                            (n = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                        ...
                        f = h = w = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0;
                        b = this.chart.plotArea.x1;
                        e = this.chart.plotArea.x2;
                        this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 };
                        D = !1;
                        if (this.parent.labels)
                            for (m = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += m)
                        ...
                        if (D) {
                            if ("axisX" === this.parent.type)
                                for (t = this.parent.convertPixelToValue({ y: d }), v = null, C = 0; C < this.parent.dataSeries.length; C++)
                                    (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
                                        0 <= v.index &&
                                        (k.text = this.labelFormatter
                                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                                            : q(this.options.label)
                                            ? v.dataPoint.label
                                            : this.label);
                        } else
                            "dateTime" === this.parent.valueType
                                ...
                                : "number" === this.parent.valueType &&
                                  (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                                      : q(this.options.label)
                                      ? Y(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                    ...
                    y = m[0];
                    b = e = n = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0;
                    f = this.chart.plotArea.y1;
                    h = this.chart.plotArea.y2;
                    this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h };
                    D = !1;
                    ...
                    if (D) {
                        if ("axisX" === this.parent.type)
                            for (t = this.parent.convertPixelToValue({ x: a }), v = null, C = 0; C < this.parent.dataSeries.length; C++)
                                (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
                                    0 <= v.index &&
                                    (k.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                    ...
                    !q(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (t = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
                    for (C = 0; C < this.parent.dataSeries.length; C++)
                        (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[C]), null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function (a, b) {
                    ...
                    if (
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), t = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else (u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y))), u < v && ((v = u), (C = t));
                    else if ("stackedColumn" === m[0].dataSeries.type || "stackedArea" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = x = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else (x += m[t].dataPoint.y), (u = Math.abs(d - this.parent.convertValueToPixel(x))), u < v && ((v = u), (C = t));
                    else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = D = x = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else
                                (x += m[t].dataPoint.y),
                                    (D = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x),
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length) for (y = 0; y < m[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y]))), u < v && ((v = u), (C = t));
                            else (u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y))), u < v && ((v = u), (C = t));
                    y = m[C];
                    b = 0;
                    if (
                        ...
                        for (t = u = 0; t < y.dataPoint.y.length; t++) (u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[t]))), u < v && ((v = u), (b = t));
                        w = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0;
                        k.text = this.labelFormatter
                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b] })
                            : q(this.options.label)
                            ? Y(q(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo)
                            : this.label;
                        this.value = y.dataPoint.y[b];
                    } else if ("stackedColumn" === this.parent.dataSeries[C].type || "stackedArea" === this.parent.dataSeries[C].type) {
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        x = u = 0;
                        for (t = C; 0 <= t; t--) (x += m[t].dataPoint.y), (u = Math.abs(d - this.parent.convertValueToPixel(x))), u < v && ((v = u), (b = t));
                        w = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0;
                        k.text = this.labelFormatter
                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y })
                            : q(this.options.label)
                            ? Y(q(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                            : this.label;
                        this.value = x;
                    } else if ("stackedColumn100" === this.parent.dataSeries[C].type || "stackedArea100" === this.parent.dataSeries[C].type) {
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        x = u = 0;
                        for (t = C; 0 <= t; t--)
                            (x += m[t].dataPoint.y),
                                ...
                                (u = Math.abs(d - this.parent.convertValueToPixel(D))),
                                u < v && ((v = u), (b = t));
                        w = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(D) << 0) + 0.5 : this.parent.convertValueToPixel(D) << 0;
                        k.text = this.labelFormatter
                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: D })
                            : q(this.options.label)
                            ? Y(q(c) ? D : c, this.valueFormatString, this.chart._cultureInfo)
                        ...
                        "waterfall" === this.parent.dataSeries[C].type
                            ? ((w =
                                  1 === r.lineWidth % 2
                                      ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0) + 0.5
                                      : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0),
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataSeries.dataPointEOs[y.index].cumulativeSum })
                                  : q(this.options.label)
                                  ? Y(q(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum))
                            : ((w = 1 === r.lineWidth % 2 ? (q(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : q(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? y.dataPoint.y : c })
                                  : q(this.options.label)
                                  ? Y(q(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataPoint.y));
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize / 2),
                        ...
                        b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) &&
                            ...
                            (0 < p && (r.moveTo(b, f), r.lineTo(e, h), r.stroke(), (this._hidden = !1)), r.restore());
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (b = e = n = 1 === r.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (h = this.chart.plotArea.y2), (this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (f = h = w = 1 === r.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 });
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        D = !1;
                        if (this.parent.labels)
                        ...
                        if (D) {
                            if ("axisX" === this.parent.type)
                                for (t = this.parent.convertPixelToValue({ y: d }), v = null, C = 0; C < this.parent.dataSeries.length; C++)
                                    (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
                                        0 <= v.index &&
                                        (k.text = this.labelFormatter
                                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? this.parent.convertPixelToValue(a) : c })
                                            : q(this.options.label)
                                            ? v.dataPoint.label
                                            : this.label);
                        } else
                            "dateTime" === this.parent.valueType
                                ? (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? this.parent.convertPixelToValue(d) : c })
                                      : q(this.options.label)
                                      ? Ba(q(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                                : "number" === this.parent.valueType &&
                                  (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? this.parent.convertPixelToValue(d) : c })
                                      : q(this.options.label)
                                      ? Y(q(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            (k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? this.parent.convertPixelToValue(a) : c })
                                : q(this.options.label)
                                ? Y(q(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label),
                                (k.x = b - k.measureText().width / 2),
                                k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                                k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
                    ...
                    if (D) {
                        ...
                        "dateTime" === this.parent.valueType
                            ? (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? this.parent.convertPixelToValue(a) : c })
                                  : q(this.options.label)
                                  ? Ba(q(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label)
                            : "number" === this.parent.valueType &&
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: q(c) ? (0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "") : c })
                                  : q(this.options.label)
                                  ? Y(q(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label);
                    k.x = b - k.measureText().width / 2;
                ...
                "left" === this.parent._position && k.x < this.chart.bounds.x1
                    ...
                    : "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2);
                0 < p && (r.moveTo(b, f), r.lineTo(e, h), r.stroke(), (this._hidden = !1));
                r.restore();
        ...
        aa.prototype.renderLabel = function () {
            q(this._textBlock) || q(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden || this._textBlock.render(!0);
        };
        qa(X, V);
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex)
                            ...
                            q(k) || ((k.dataSeries = e), (this.currentDataPointIndex = k.index), (b = k.dataPoint));
                        }
        ...
        X.prototype.highlightObjects = function (a) {
            ...
            if (q(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas)
                        ...
                        "rangeSplineArea" === b.type
                            ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                              ...
                              "undefined" !== typeof e.y2 &&
                                  ...
                                  Z.drawMarkers([f])))
                            : "bubble" === b.type
                            ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), Z.drawMarkers([f]), (d.globalAlpha = 1))
                            : "column" === b.type ||
                            ...
                            ? ra(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
                            ...
                            ? (d.save(),
                              ...
                              d.restore(),
                              (d.globalAlpha = 1))
                            : "error" === b.type && C(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
                }
            }
            d.restore();
            d.globalAlpha = 1;
                    ...
                    (c = a[h].dataSeries),
                        ...
                        0 === h &&
                            ...
                            (this.chart.axisX && 0 < this.chart.axisX.length
                                ? (q += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}")
                                : this.chart.axisX2 && 0 < this.chart.axisX2.length && (q += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"),
                            (q += "</br>"),
                        ...
                        null === b.toolTipContent ||
                            ...
                            "waterfall" === c.type
                                ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += n != c.axisXIndex ? (c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>") : ""),
                                  (f += b.toolTipContent
                                      ? b.toolTipContent
                                      : c.toolTipContent
                                      ? c.toolTipContent
        ...
        X.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var h = 0; h < this.chart.data.length; h++) (c = this.chart.data[h]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !q(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
            else (c = this.chart.data[d]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !q(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
            if (0 < f.length) {
        ...
        var N = {
            ...
            Z = {
                    ...
                    if (c) {
                        ...
                        "circle" === b
                            ? (c.moveTo(a, d),
                              ...
                              f && c.fill(),
                              n && (h ? c.stroke() : ((q = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = q))))
                            : "square" === b
                            ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), n && (h ? c.stroke() : ((q = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = q))))
                            : "triangle" === b
                            ? (c.beginPath(),
                ...
                drawMarkers: function (a) {
                    for (var d = 0; d < a.length; d++) {
                        var c = a[d];
                        Z.drawMarker(c.x, c.y, c.ctx, c.type, c.size, c.color, c.borderColor, c.borderThickness);
                    }
                },
            };
        return n;
